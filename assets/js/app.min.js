...
m(b-d/2,c-e,d,e)]}function m(a,b,c,d){return{x:a,y:b,width:c,height:d}}function n(a){return a[o(a)]}function o(a){return Math.floor(Math.random()*a.length)}function p(a,b,c){var d=a.slice();return d[b]=c,d}function q(){function b(a,b){
// For one point choose a random other placement.
var c=o(a),d=a[c],e=l(d),f=n(e);return p(b,c,f)}function c(a){for(var b=j(a),c=1,e=0;e<a.length;e++){var f=a[e];c+=d(f)?0:100}return b*c}var d=k(),e=1e3,f=1,g=function(a){for(var d=a,g=a,h=1/0,i=e;i>0;){var j=b(d,g),k=c(j),l=Math.exp((h-k)/i);(h>k||l>Math.random())&&(g=j,h=k),i-=f}return g};return g.temperature=function(a){return arguments.length?(e=a,g):e},g.cooling=function(a){return arguments.length?(f=a,g):f},a.rebind(g,d,"containerWidth"),a.rebind(g,d,"containerHeight"),g}function r(){function b(a,b){
...
var f=l(a[d[1]]),g=f.map(function(a){return p(b,d[1],a)}),h=e(g,function(a){var b=i(a,d[1]),e=c(a[d[1]]);return b+(e?0:Number.MAX_VALUE)});b=h}),b}var c=k(),d=1,f=function(a){
// Keep going until there's no more iterations to do or
// the solution is a local minimum
for(var c=a,e=a,f=Number.MAX_VALUE,g=1/0,h=0;d>h&&g>f;)g=f,e=b(c,e),f=j(e),h++;return e};return f.iterations=function(a){return arguments.length?(d=a,f):d},a.rebind(f,c,"containerWidth"),a.rebind(f,c,"containerHeight"),f}function s(){function b(a,b){var c=a.slice();return c.push(b),c}function c(a){for(var b=j(a),c=!0,e=0;e<a.length&&c;e++){var f=a[e];c=d(f)}return b+(c?0:1/0)}var d=k(),f=function(a){var d=[];return a.forEach(function(a){var f=l(a),g=f.map(function(a){return b(d,a)});d=e(g,c)}),d};return a.rebind(f,d,"containerWidth"),a.rebind(f,d,"containerHeight"),f}function t(){var a=1,b=1,c=function(c){return c.map(function(c,d){var e=c.x,f=c.y;return e+c.width>a&&(e-=c.width),f+c.height>b&&(f-=c.height),{x:e,y:f}})};return c.containerWidth=function(b){return arguments.length?(a=b,c):a},c.containerHeight=function(a){return arguments.length?(b=a,c):b},c}function u(){return this}function v(a){return a}function w(a,b){return b}function x(a){}
// Wrapper around d3's selectAll/data data-join, which allows decoration of the result.
// This is achieved by appending the element to the enter selection before exposing it.
// A default transition of fade in/out is also implicitly added but can be modified.
function y(){var b="g",c=!1,d="g",e={},f=w,g=function(g,h){var i=h||v;
...
function B(a,b){z(a)?a.rangePoints(b,1):a.range(b)}
...
function C(b){var c=b.map(function(b){return a.functor(b)});return function(a,b){return c.map(function(c){return c(a,b)})}}function D(b){var c=a.functor([0,0]),e=function(a,b){return[a.x,a.y]},f=a.scale.identity(),g=a.scale.identity(),h=x,i=b||v,j=x,k=y().selector("g.rectangle").element("g").attr("class","rectangle"),l=function(a){var b=A(f),d=A(g);i.containerWidth&&i.containerWidth(Math.max(b[0],b[1])),i.containerHeight&&i.containerHeight(Math.max(d[0],d[1])),a.each(function(a,b){var d=k(this,a),f=a.map(function(a,b){var d=e(a,b),f=c(a,b);return{x:d[0],y:d[1],width:f[0],height:f[1]}}),g=i(f);
// offset each rectangle accordingly
d.attr("transform",function(a,b){var c=g[b];return"translate("+c.x+", "+c.y+")"}),
// set the anchor-point for each rectangle
a.forEach(function(a,b){var c=e(a,b),d=[c[0]-g[b].x,c[1]-g[b].y];h(a,b,d)}),
// set the layout width / height so that children can use SVG layout if required
d.attr({"layout-width":function(a,b){return f[b].width},"layout-height":function(a,b){return f[b].height}}),d.call(j)})};return d(l,i),l.size=function(a){return arguments.length?(c=C(a),l):c},l.position=function(a){return arguments.length?(e=C(a),l):e},l.anchor=function(a){return arguments.length?(h=a,l):h},l.xScale=function(a){return arguments.length?(f=a,l):f},l.yScale=function(a){return arguments.length?(g=a,l):g},l.component=function(a){return arguments.length?(j=a,l):j},l}/* global requestAnimationFrame:false */
// Debounce render to only occur once per frame
function E(a){var b=null;return function(){null==b&&(b=requestAnimationFrame(function(){b=null,a()}))}}function F(a,b){return function(a,b){return{x:a,y:b}}}function G(a,b,c,d,e,f){
// a default function that computes the distance between two points
return f=f||function(a,b,c,d){var e=a-c,f=b-d;return e*e+f*f},function(g,h){var i=e.map(function(e){var i=f(g,h,a(c(e)),b(d(e)));return[i,e]}).reduce(function(a,b){return a[0]>b[0]?b:a},[Number.MAX_VALUE,null])[1];return{datum:i,x:i?a(c(i)):g,y:i?b(d(i)):h}}}function H(a,b,c){return function(d,e){var f=a.xScale(),g=a.yScale(),h=a.xValue(),i=(a.yValue||a.yCloseValue).call(a);return G(f,g,h,i,b,c)(d,e)}}function I(a,b){function c(a,b,c,d){var e=a-c;return Math.abs(e)}return H(a,b,c)}function J(a,b){function c(a,b,c,d){var e=b-d;return Math.abs(e)}return H(a,b,c)}
// returns the width and height of the given element minus the padding.
function K(a){var b=a.ownerDocument.defaultView.getComputedStyle(a);return{width:parseFloat(b.width)-parseFloat(b.paddingLeft)-parseFloat(b.paddingRight),height:parseFloat(b.height)-parseFloat(b.paddingTop)-parseFloat(b.paddingBottom)}}
...
var d=a.pairs(c).map(function(a){return Math.abs(a[0]-a[1])}),e=a.min(d);return b*e}}/**
   ...
   * @memberof fc.util
   */
function M(){var b=[],c=null,d="percent",e=0,f=null,g=function(g){
...
function S(){var b=a.time.scale(),c=a.scale.linear(),d=[],e=u,f=w,g=x,h=y().selector("g.multi").children(!0).attr("class","multi").element("g").key(function(a,b){
...
a.selection.prototype.order.call(i),g(i)})};return i.xScale=function(a){return arguments.length?(b=a,i):b},i.yScale=function(a){return arguments.length?(c=a,i):c},i.series=function(a){return arguments.length?(d=a,i):d},i.mapping=function(a){return arguments.length?(e=a,i):e},i.key=function(a){return arguments.length?(f=a,i):f},i.decorate=function(a){return arguments.length?(g=a,i):g},i}function T(){function b(){}var c=a.time.scale(),d=a.scale.linear(),e=a.functor(0),f=a.functor(0),g=function(a,b){return a.date},h=function(a,b){return a.close};return b.x0=function(a,b){return c(f(a,b))},b.y0=function(a,b){return d(e(a,b))},b.x=b.x1=function(a,b){return c(g(a,b))},b.y=b.y1=function(a,b){return d(h(a,b))},b.defined=function(a,b){return null!=f(a,b)&&null!=e(a,b)&&null!=g(a,b)&&null!=h(a,b)},b.xScale=function(a){return arguments.length?(c=a,b):c},b.yScale=function(a){return arguments.length?(d=a,b):d},b.x0Value=function(c){return arguments.length?(f=a.functor(c),b):f},b.y0Value=function(c){return arguments.length?(e=a.functor(c),b):e},b.xValue=b.x1Value=function(c){return arguments.length?(g=a.functor(c),b):g},b.yValue=b.y1Value=function(c){return arguments.length?(h=a.functor(c),b):h},b}function U(){var b=x,c=a.svg.symbol(),d=T(),e=y().selector("g.point").element("g").attr("class","point"),f=function(a,b){return"translate("+d.x(a,b)+", "+d.y(a,b)+")"},g=function(a){a.each(function(a,g){var h=a.filter(d.defined),i=e(this,h);i.enter().attr("transform",f).append("path"),i.attr("transform",f).select("path").attr("d",c),b(i,a,g)})};return g.decorate=function(a){return arguments.length?(b=a,g):b},a.rebind(g,d,"xScale","xValue","yScale","yValue"),a.rebind(g,e,"key"),a.rebind(g,c,"size","type"),g}function V(){
...
// these annotations.
function c(b){return a.scale.identity().range(A(b))}function d(){var b=a.mouse(this),c=a.select(this),d=j.apply(this,b),e=c.datum();e.push(d),c.call(r),g.trackingstart.apply(this,arguments)}function e(){var b=a.mouse(this),c=a.select(this),d=j.apply(this,b),e=c.datum();e[e.length-1]=d,c.call(r),g.trackingmove.apply(this,arguments)}function f(){var b=a.select(this),c=b.datum();c.pop(),b.call(r),g.trackingend.apply(this,arguments)}var g=a.dispatch("trackingstart","trackingmove","trackingend"),h=a.time.scale(),i=a.scale.linear(),j=function(a,b){return F(h,i)(a,b)},k=x,l=function(a){return a.x},m=function(a){return a.y},n=y().children(!0).selector("g.crosshair").element("g").attr("class","crosshair"),o=U().xValue(l).yValue(m),p=R().value(m).label(function(a){return a.y}),q=R().orient("vertical").value(l).label(function(a){return a.x}),r=function(b){b.each(function(b,g){var j=a.select(this).style("pointer-events","all").on("mouseenter.crosshair",d).on("mousemove.crosshair",e).on("mouseleave.crosshair",f),l=j.selectAll("rect").data([b]);l.enter().append("rect").style("visibility","hidden"),j.select("rect").attr("x",A(h)[0]).attr("y",A(i)[1]).attr("width",A(h)[1]).attr("height",A(i)[0]);var m=n(j,b);m.enter().style("pointer-events","none");var r=S().series([p,q,o]).xScale(c(h)).yScale(c(i)).mapping(function(){return[this]});m.call(r),k(m,b,g)})};return r.xScale=function(a){return arguments.length?(h=a,r):h},r.yScale=function(a){return arguments.length?(i=a,r):i},r.snap=function(a){return arguments.length?(j=a,r):j},r.decorate=function(a){return arguments.length?(k=a,r):k},a.rebind(r,g,"on"),b(r,p,{yLabel:"label"}),b(r,q,{xLabel:"label"}),r}
// Renders an error bar series as an SVG path based on the given array of datapoints.
function W(){var b=function(a,b){return a.x},c=function(a,b){return a.y},d=function(a,b){return a.errorHigh},e=function(a,b){return a.errorLow},f="vertical",g=a.functor(5),h=function(a){return a.map(function(a,h){var i=g(a,h)/2,j=d(a,h)-e(a,h),k=c(a,h)-e(a,h),l=d(a,h)-c(a,h),m=b(a,h)-e(a,h),n=d(a,h)-b(a,h),o="",p="";if("vertical"===f){var q="h"+-i+"h"+2*i+"h"+-i,r="v"+-j;o="M0,"+k+q+r+q+"M0,"+l}else{var s="v"+-i+"v"+2*i+"v"+-i,t="h"+-j;p="M"+m+",0"+s+t+s+"M"+n+",0"}return o+p}).join("")};return h.x=function(c){return arguments.length?(b=a.functor(c),h):b},h.y=function(b){return arguments.length?(c=a.functor(b),h):c},h.errorHigh=function(b){return arguments.length?(d=a.functor(b),h):d},h.errorLow=function(b){return arguments.length?(e=a.functor(b),h):e},h.barWidth=function(b){return arguments.length?(g=a.functor(b),h):g},h.orient=function(a){return arguments.length?(f=a,h):f},h}
// Renders an OHLC as an SVG path based on the given array of datapoints. Each
// OHLC has a fixed width, whilst the x, open, high, low and close positions are
// obtained from each point via the supplied accessor functions.
function X(){var b=function(a,b){return a.date},c=function(a,b){return a.open},d=function(a,b){return a.high},e=function(a,b){return a.low},f=function(a,b){return a.close},g=a.functor(3),h=function(a){return a.map(function(a,h){var i=b(a,h),j=c(a,h),k=d(a,h),l=e(a,h),m=f(a,h),n=g(a,h)/2,o="M"+i+","+l,p="V"+k,q="M"+i+","+j+"h"+-n,r="M"+i+","+m+"h"+n;return o+p+q+r}).join("")};return h.x=function(c){return arguments.length?(b=a.functor(c),h):b},h.open=function(b){return arguments.length?(c=a.functor(b),h):c},h.high=function(b){return arguments.length?(d=a.functor(b),h):d},h.low=function(b){return arguments.length?(e=a.functor(b),h):e},h.close=function(b){return arguments.length?(f=a.functor(b),h):f},h.width=function(b){return arguments.length?(g=a.functor(b),h):g},h}
...
// obtained from each point via the supplied accessor functions.
function Y(){var b=function(a,b){return a.date},c=function(a,b){return a.open},d=function(a,b){return a.high},e=function(a,b){return a.low},f=function(a,b){return a.close},g=a.functor(3),h=function(a){return a.map(function(a,h){var i=b(a,h),j=c(a,h),k=d(a,h),l=e(a,h),m=f(a,h),n=g(a,h),o="M"+(i-n/2)+","+j+
// Draw the width
"h"+n+
...
// the bound data
function b(a,b){return function(c){return b(a(c),0)}}function c(a,b){return e()?"translate("+b+", "+a+")":"translate("+a+", "+b+")"}function d(a){return e()?a.map(function(a){return[a[1],a[0]]}):a}function e(){return"left"===i||"right"===i}function f(a,b){return g[a]?g[a].apply(g,j):b}var g=a.scale.identity(),h=x,i="bottom",j=[10],k=null,l=null,m=6,n=6,o=3,p=a.svg.line(),q=y().selector("g.tick").element("g").key(v).attr("class","tick"),r=y().selector("path.domain").element("path").attr("class","domain"),s=function(e){e.each(function(e,j){
// Stash a snapshot of the new scale, and retrieve the old snapshot.
var s=this.__chart__||g;this.__chart__=g.copy();var t=null==k?f("ticks",g.domain()):k,u=null==l?f("tickFormat",v):l,w="bottom"===i||"right"===i?1:-1,x=a.select(this),y=A(g),B=d([[y[0],w*m],[y[0],0],[y[1],0],[y[1],w*m]]),C=r(x,[e]);C.attr("d",p(B)),
...
transform:b(z(g)?g:s,c)});var D=q(x,t);
// enter
D.enter().append("path");var E=w*(n+o);D.enter().append("text").attr("transform",c(0,E)),
// update
D.attr("class","tick orient-"+i),D.attr("transform",b(g,c)),D.selectAll("path").attr("d",function(a){return p(d([[0,0],[0,w*n]]))}),D.selectAll("text").attr("transform",c(0,E)).text(u),
// exit - for non ordinal scales, exit by animating the tick to its new location
z(g)||D.exit().attr("transform",b(g,c)),h(D,e,j)})};return s.scale=function(a){return arguments.length?(g=a,s):g},s.ticks=function(a){return arguments.length?(j=arguments,s):j},s.tickValues=function(a){return arguments.length?(k=a,s):k},s.tickFormat=function(a){return arguments.length?(l=a,s):l},s.tickSize=function(a){var b=arguments.length;return b?(n=Number(a),m=Number(arguments[b-1]),s):n},s.innerTickSize=function(a){return arguments.length?(n=Number(a),s):n},s.outerTickSize=function(a){return arguments.length?(m=Number(a),s):m},s.tickPadding=function(a){return arguments.length?(o=a,s):o},s.orient=function(a){return arguments.length?(i=a,s):i},s.decorate=function(a){return arguments.length?(h=a,s):h},s}function _(){var a="",b=function(a){return a.y},c=!1,d=function(a,b,c){return b===c.length-1?"Final":void 0},e={up:"up",down:"down",unchanged:"unchanged"},f=function(f){var g,h,i,j=f.length,k=0,l=0,m=[];for(c&&(l=b(f[0]),m.push({x:f[0][a],y0:0,y1:l,direction:e.unchanged}),k=1),k;j>k;k+=1)g=l,h=b(f[k])+l,m.push({x:f[k][a],y0:g,y1:h,direction:h-g>0?e.up:e.down}),i=d(f[k],k,f),i&&m.push({x:i,y0:0,y1:h,direction:e.unchanged}),l=h;return m};return f.xValueKey=function(b){return arguments.length?(a=b,f):a},f.yValue=function(a){return arguments.length?(b=a,f):b},f.total=function(a){return arguments.length?(d=a,f):d},f.startsWithTotal=function(a){return arguments.length?(c=a,f):c},f}
...
function aa(){function b(a,b){return"vertical"===i?"translate("+k.x1(a,b)+", "+k.y0(a,b)+")":"translate("+k.x0(a,b)+", "+k.y1(a,b)+")"}function c(a,b){return"vertical"===i?k.y1(a,b)-k.y0(a,b):k.x1(a,b)-k.x0(a,b)}function d(a){return"vertical"===i?a.height:a.width}function e(a){return"vertical"===i?a.width:a.height}function f(){return"vertical"===i?k.x:k.y}var g=x,h=L(.75),i="vertical",j=Z(),k=T().xValue(function(a,b){return"vertical"===i?a.date:a.close}).yValue(function(a,b){return"vertical"===i?a.close:a.date}),l=y().selector("g.bar").element("g"),m=function(a){a.each(function(a,m){if("vertical"!==i&&"horizontal"!==i)throw new Error("The bar series does not support an orientation of "+i);l.attr("class","bar "+i);var n=a.filter(k.defined);j.x(0).y(0).width(0).height(0),"vertical"===i?j.verticalAlign("top"):j.horizontalAlign("right");
...
d(j)(c),p.attr("transform",b).select("path").attr("d",function(a){return j([a])}),g(p,n,m)})};return m.decorate=function(a){return arguments.length?(g=a,m):g},m.barWidth=function(b){return arguments.length?(h=a.functor(b),m):h},m.orient=function(a){return arguments.length?(i=a,m):i},a.rebind(m,k,"xScale","xValue","x1Value","x0Value","yScale","yValue","y1Value","y0Value"),a.rebind(m,l,"key"),m}function ba(){function a(){return"vertical"===b.orient()}var b=aa(),c=function(c){b.xValue(function(b,c){return a()?b.x:b.y1}).yValue(function(b,c){return a()?b.y1:b.x}).x0Value(function(b,c){return a()?0:b.y0}).y0Value(function(b,c){return a()?b.y0:0}).decorate(function(a,c,d){a.enter().attr("class","waterfall "+b.orient()).classed("up",function(a){return"up"===a.direction}).classed("down",function(a){return"down"===a.direction})}),b(c)};return d(c,b),c}function ca(){function b(){}var c=a.time.scale(),d=a.scale.linear(),e=a.functor(0),f=a.functor(0),g=function(a,b){return a.date},h=function(a,b){return a.close},i="vertical",j=a.functor(5);return b.width=function(a,b){return j("vertical"===b?a.map(function(a,b){return c(g(a,b))}):a.map(function(a,b){return d(h(a,b))}))},b.values=function(a,b){return"vertical"===i?{x:c(g(a,b)),y:d(h(a,b)),errorHigh:d(e(a,b)),errorLow:d(f(a,b))}:{x:c(g(a,b)),y:d(h(a,b)),errorHigh:c(e(a,b)),errorLow:c(f(a,b))}},b.defined=function(a,b){return null!=f(a,b)&&null!=e(a,b)&&null!=g(a,b)&&null!=h(a,b)},b.orient=function(a){return arguments.length?(i=a,b):i},b.xScale=function(a){return arguments.length?(c=a,b):c},b.yScale=function(a){return arguments.length?(d=a,b):d},b.errorLow=function(c){return arguments.length?(f=a.functor(c),b):f},b.errorHigh=function(c){return arguments.length?(e=a.functor(c),b):e},b.xValue=function(c){return arguments.length?(g=a.functor(c),b):g},b.yValue=function(c){return arguments.length?(h=a.functor(c),b):h},b.barWidth=function(c){return arguments.length?(j=a.functor(c),b):j},b}function da(){var b=x,c=5,e="vertical",f=ca(),g=y().selector("g.errorBar").element("g").attr("class","errorBar"),h=function(c){f.orient(h.orient()),c.each(function(c,d){var e=c.filter(f.defined),i=g(this,e);i.enter().append("path");var j=W().orient(h.orient()).barWidth(f.width(e));i.each(function(b,c){var d=f.values(b,c),e=a.select(this).attr("transform","translate("+d.x+", "+d.y+")");j.x(d.x).errorHigh(d.errorHigh).errorLow(d.errorLow).y(d.y),e.select("path").attr("d",j([b])).attr("stroke","black")}),b(i,c,d)})};return h.barWidth=function(a){return arguments.length?(c=a,h):c},h.orient=function(a){return arguments.length?(e=a,h):e},h.decorate=function(a){return arguments.length?(b=a,h):b},a.rebind(h,g,"key"),d(h,f),h}function ea(){function b(){}var c=a.time.scale(),d=a.scale.linear(),e=function(a,b){return a.date},f=function(a,b){return a.open},g=function(a,b){return a.high},h=function(a,b){return a.low},i=function(a,b){return a.close},j=L(.75),k=function(a,b){return c(e(a,b))};return b.width=function(a){return j(a.map(k))},b.defined=function(a,b){return null!=e(a,b)&&null!=f(a,b)&&null!=h(a,b)&&null!=g(a,b)&&null!=i(a,b)},b.values=function(a,b){var c=i(a,b),e=f(a,b),j="";return c>e?j="up":e>c&&(j="down"),{x:k(a,b),yOpen:d(e),yHigh:d(g(a,b)),yLow:d(h(a,b)),yClose:d(c),direction:j}},b.xScale=function(a){return arguments.length?(c=a,b):c},b.yScale=function(a){return arguments.length?(d=a,b):d},b.xValue=function(a){return arguments.length?(e=a,b):e},b.yOpenValue=function(a){return arguments.length?(f=a,b):f},b.yHighValue=function(a){return arguments.length?(g=a,b):g},b.yLowValue=function(a){return arguments.length?(h=a,b):h},b.yValue=b.yCloseValue=function(a){return arguments.length?(i=a,b):i},b.barWidth=function(c){return arguments.length?(j=a.functor(c),b):j},b}function fa(){var b=aa(),c=L(.75),d=x,e=a.scale.linear(),f=a.scale.linear(),g=function(a){return a.values},h=y().selector("g.stacked").element("g").attr("class","stacked"),i=function(a,c){return e(b.xValue()(a,c))},j=function(j){j.each(function(j){var k=c(g(j[0]).map(i)),l=k/(j.length-1);b.barWidth(l);var m=k/2;f.domain([0,j.length-1]).range([-m,m]);var n=h(this,j);n.enter().append("g"),n.select("g").datum(g).each(function(c,g){var h=a.select(this),i=function(a){return e(a)+f(g)};b.xScale(i),
// adapt the decorate function to give each series the correct index
b.decorate(function(a,b){d(a,b,g)}),h.call(b)})})};return j.decorate=function(a){return arguments.length?(d=a,j):d},j.xScale=function(a){return arguments.length?(e=a,j):e},j.values=function(a){return arguments.length?(g=a,j):g},a.rebind(j,b,"yValue","xValue","yScale"),j}function ga(){var b=x,c=T(),d=a.svg.line().defined(c.defined).x(c.x).y(c.y),e=y().selector("path.line").element("path").attr("class","line"),f=function(a){a.each(function(a,c){var f=e(this,[a]);f.attr("d",d),b(f,a,c)})};return f.decorate=function(a){return arguments.length?(b=a,f):b},a.rebind(f,c,"xScale","xValue","yScale","yValue"),a.rebind(f,e,"key"),a.rebind(f,d,"interpolate","tension"),f}function ha(){var b=x,c=function(a){return a.values},d=function(d){d.each(function(d){var e=a.select(this),f=y().selector("g.stacked").element("g").attr("class","stacked"),g=f(e,d);g.enter().append("g"),g.select("g").datum(c).call(b)})};return d.series=function(a){return arguments.length?(b=a,d):b},d.values=function(a){return arguments.length?(c=a,d):c},d}function ia(){var a=ga().yValue(function(a){return a.y0+a.y}),b=ha().series(a),c=function(a){a.call(b)};return d(c,a),c}function ja(){var a=aa().yValue(function(a){return a.y0+a.y}).y0Value(function(a){return a.y0}),b=ha().series(a),c=function(a){a.call(b)};return d(c,a),c}function ka(){var b=x,c=T(),d=a.svg.area().defined(c.defined).x(c.x).y0(c.y0).y1(c.y1),e=y().selector("path.area").element("path").attr("class","area"),f=function(a){a.each(function(a,c){var f=e(this,[a]);f.attr("d",d),b(f,a,c)})};return f.decorate=function(a){return arguments.length?(b=a,f):b},a.rebind(f,c,"xScale","xValue","yScale","yValue","y1Value","y0Value"),a.rebind(f,e,"key"),a.rebind(f,d,"interpolate","tension"),f}function la(){var a=ka().yValue(function(a){return a.y0+a.y}).y0Value(function(a){return a.y0}),b=ha().series(a),c=function(a){a.call(b)};return d(c,a),c}function ma(b){function c(a){return"translate("+a.x+", "+a.yHigh+")"}var e=x,f=ea(),g=y().selector("g.ohlc").element("g").attr("class","ohlc"),h=function(b){b.each(function(b,d){var h=b.filter(f.defined),i=g(this,h);i.enter().attr("transform",function(a,b){return c(f.values(a,b))+" scale(1e-6, 1)"}).append("path");var j=X().width(f.width(h));i.each(function(b,d){var e=f.values(b,d),g=a.transition(a.select(this)).attr({"class":"ohlc "+e.direction,transform:function(){return c(e)+" scale(1)"}});j.x(a.functor(0)).open(function(){return e.yOpen-e.yHigh}).high(function(){return e.yHigh-e.yHigh}).low(function(){return e.yLow-e.yHigh}).close(function(){return e.yClose-e.yHigh}),g.select("path").attr("d",j([b]))}),e(i,b,d)})};return h.decorate=function(a){return arguments.length?(e=a,h):e},a.rebind(h,g,"key"),d(h,f),h}function na(){var b=x,c=a.scale.linear(),d=a.scale.linear(),e=function(a,b){return a.date.getDay()},f=a.scale.linear(),g=ga(),h=L(.75),i=y().selector("g.cycle").element("g").attr("class","cycle"),j=function(j){j.each(function(j,k){var l=a.nest().key(e).map(j),m=Object.keys(l),n=h(m.map(c)),o=n/2,p=i(this,m);p.each(function(b,e){var h=a.select(this);h.attr("transform","translate("+c(b)+", 0)"),(f.rangeBands||f.range)([-o,o]),g.xScale(f).yScale(d),a.select(this).datum(l[b]).call(g)}),b(p,m,k)})};return j.decorate=function(a){return arguments.length?(b=a,j):b},j.xScale=function(a){return arguments.length?(c=a,j):c},j.yScale=function(a){return arguments.length?(d=a,j):d},j.xValue=function(a){return arguments.length?(e=a,j):e},j.subScale=function(a){return arguments.length?(f=a,j):f},j.subSeries=function(a){return arguments.length?(g=a,j):g},j.barWidth=function(b){return arguments.length?(h=a.functor(b),j):h},a.rebind(j,i,"key"),j}function oa(){function b(a){return"translate("+a.x+", "+a.yHigh+")"}var c=x,e=ea(),f=y().selector("g.candlestick").element("g").attr("class","candlestick"),g=function(d){d.each(function(d,g){var h=d.filter(e.defined),i=f(this,h);i.enter().attr("transform",function(a,c){return b(e.values(a,c))+" scale(1e-6, 1)"}).append("path");var j=Y().width(e.width(h));i.each(function(c,d){var f=e.values(c,d),g=a.transition(a.select(this)).attr({"class":"candlestick "+f.direction,transform:function(){return b(f)+" scale(1)"}});j.x(a.functor(0)).open(function(){return f.yOpen-f.yHigh}).high(function(){return f.yHigh-f.yHigh}).low(function(){return f.yLow-f.yHigh}).close(function(){return f.yClose-f.yHigh}),g.select("path").attr("d",j([c]))}),c(i,d,g)})};return g.decorate=function(a){return arguments.length?(c=a,g):c},a.rebind(g,f,"key"),d(g,e),g}
...
function pa(){var b=$(),c=a.functor(0),d=x,e=a.time.scale(),f=a.scale.linear(),g=y().selector("g.axis-adapter").element("g").attr({"class":"axis axis-adapter"}),h=function(a){a.each(function(a,i){var j,k=g(this,[a]);switch(h.orient()){case"top":case"bottom":j="translate(0,"+f(c(a))+")",b.scale(e);break;case"left":case"right":j="translate("+e(c(a))+",0)",b.scale(f);break;default:throw new Error("Invalid orientation")}k.enter().attr("transform",j),k.attr("transform",j),k.call(b),d(k,a,i)})};return h.baseline=function(b){return arguments.length?(c=a.functor(b),h):c},h.decorate=function(a){return arguments.length?(d=a,h):d},h.xScale=function(a){return arguments.length?(e=a,h):e},h.yScale=function(a){return arguments.length?(f=a,h):f},a.rebind(h,b,"orient","ticks","tickValues","tickSize","innerTickSize","outerTickSize","tickPadding","tickFormat")}function qa(){var a={};return a.distance=function(a,b){return b.getTime()-a.getTime()},a.offset=function(a,b){return new Date(a.getTime()+b)},a.clampUp=v,a.clampDown=v,a.copy=function(){return a},a}
// obtains the ticks from the given scale, transforming the result to ensure
// it does not include any discontinuities
function ra(a,b,c){var d=a.map(function(d,e){if(e<a.length-1)return b.clampUp(d);var f=b.clampUp(d);return f<c[1]?f:b.clampDown(d)}),e=d.reduce(function(a,b){return 0===a.filter(function(a){return a.getTime()===b.getTime()}).length&&a.push(b),a},[]);return e}/**
  ...
  */
function sa(b,c){function d(a){var d=b.domain(),e=b.range(),f=c.distance(d[0],d[1]),g=c.distance(d[0],a),h=g/f,i=h*(e[1]-e[0])+e[0];return i}return arguments.length||(b=a.time.scale(),c=qa()),d.invert=function(a){var d=b.domain(),e=b.range(),f=(a-e[0])/(e[1]-e[0]),g=c.distance(d[0],d[1]),h=f*g;return c.offset(d[0],h)},d.domain=function(a){if(!arguments.length)return b.domain();
// clamp the upper and lower domain values to ensure they
// do not fall within a discontinuity
var e=c.clampUp(a[0]),f=c.clampDown(a[1]);return b.domain([e,f]),d},d.nice=function(){b.nice();var a=b.domain(),e=c.clampUp(a[0]),f=c.clampDown(a[1]);return b.domain([e,f]),d},d.ticks=function(){var a=b.ticks.apply(this,arguments);return ra(a,c,d.domain())},d.copy=function(){return sa(b.copy(),c.copy())},d.discontinuityProvider=function(a){return arguments.length?(c=a,d):c},a.rebind(d,b,"range","rangeRound","interpolate","clamp","tickFormat")}function ta(){return sa()}function ua(){function b(a){return 0===a.getDay()||6===a.getDay()}var c=864e5,d=5*c,e=7*c,f={};
...
return g=a.time.day.offset(g,7*j),h-=j*d,g=new Date(g.getTime()+h)},f.copy=function(){return f},f}function va(){var b=a.time.scale(),c=a.scale.linear(),d=function(a){return a.date},e=function(a){return a.elderRay},f=aa(),g=aa(),h=aa(),i=aa(),j=S(),k=x,l=function(a){function l(a,b){
// The values share parity and the input is smaller than the comparison
return a*b>0&&Math.abs(a)<Math.abs(b)}f.xValue(d).yValue(function(a,b){return l(e(a).bullPower,e(a).bearPower)?void 0:e(a).bullPower}),g.xValue(d).yValue(function(a,b){return l(e(a).bearPower,e(a).bullPower)?void 0:e(a).bearPower}),h.xValue(d).yValue(function(a,b){return l(e(a).bullPower,e(a).bearPower)?e(a).bullPower:void 0}),i.xValue(d).yValue(function(a,b){return l(e(a).bearPower,e(a).bullPower)?e(a).bearPower:void 0}),j.xScale(b).yScale(c).series([f,g,h,i]).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi "+["bull","bear","bull top","bear top"][b]}),k(a,b,c)}),a.call(j)};return l.xScale=function(a){return arguments.length?(b=a,l):b},l.xValue=function(a){return arguments.length?(d=a,l):d},l.yScale=function(a){return arguments.length?(c=a,l):c},l.decorate=function(a){return arguments.length?(k=a,l):k},l}function wa(){var b=a.time.scale(),c=a.scale.linear(),d=function(a,b){return a.close},e=function(a,b){return a.date},f=function(a){return a.envelope},g=x,h=ka().y0Value(function(a,b){return f(a).upper}).y1Value(function(a,b){return f(a).lower}),i=ga().yValue(function(a,b){return f(a).upper}),j=ga().yValue(function(a,b){return f(a).lower}),k=function(a){var d=S().xScale(b).yScale(c).series([h,i,j]).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi envelope "+["area","upper","lower"][b]}),g(a,b,c)});h.xValue(e),i.xValue(e),j.xValue(e),a.call(d)};return k.xScale=function(a){return arguments.length?(b=a,k):b},k.yScale=function(a){return arguments.length?(c=a,k):c},k.xValue=function(a){return arguments.length?(e=a,k):e},k.yValue=function(a){return arguments.length?(d=a,k):d},k.root=function(a){return arguments.length?(f=a,k):f},k.decorate=function(a){return arguments.length?(g=a,k):g},k}function xa(){var b=a.time.scale(),c=a.scale.linear(),d=S(),e=x,f=R(),g=ga().yValue(function(a,b){return a.force}),h=function(a){d.xScale(b).yScale(c).series([f,g]).mapping(function(a){return a===f?[0]:this}).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi "+["annotations","indicator"][b]}),e(a,b,c)}),a.call(d)};return h.xScale=function(a){return arguments.length?(b=a,f.xScale(a),h):b},h.yScale=function(a){return arguments.length?(c=a,f.yScale(a),h):c},h.decorate=function(a){return arguments.length?(e=a,h):e},a.rebind(h,g,"yValue","xValue"),h}function ya(){var b=a.time.scale(),c=a.scale.linear(),d=80,e=20,f=S(),g=x,h=R(),i=ga().yValue(function(a,b){return a.stochastic.d}),j=ga().yValue(function(a,b){return a.stochastic.k}),k=function(a){f.xScale(b).yScale(c).series([h,i,j]).mapping(function(a){return a===h?[d,e]:this}).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi stochastic "+["annotations","stochastic-d","stochastic-k"][b]}),g(a,b,c)}),a.call(f)};return k.xScale=function(a){return arguments.length?(b=a,k):b},k.yScale=function(a){return arguments.length?(c=a,k):c},k.upperValue=function(a){return arguments.length?(d=a,k):d},k.lowerValue=function(a){return arguments.length?(e=a,k):e},k.decorate=function(a){return arguments.length?(g=a,k):g},a.rebind(k,i,"yDValue","xDValue"),a.rebind(k,j,"yKValue","xKValue"),k}function za(){var b=a.time.scale(),c=a.scale.linear(),d=70,e=30,f=S(),g=x,h=R(),i=ga().yValue(function(a,b){return a.rsi}),j=function(a){f.xScale(b).yScale(c).series([i,h]).mapping(function(a){return a===h?[d,50,e]:this}).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi rsi "+["indicator","annotations"][b]}),g(a,b,c)}),a.call(f)};return j.xScale=function(a){return arguments.length?(b=a,j):b},j.yScale=function(a){return arguments.length?(c=a,j):c},j.upperValue=function(a){return arguments.length?(d=a,j):d},j.lowerValue=function(a){return arguments.length?(e=a,j):e},j.decorate=function(a){return arguments.length?(g=a,j):g},a.rebind(j,i,"yValue","xValue"),j}function Aa(){var b=a.time.scale(),c=a.scale.linear(),d=function(a){return a.date},e=function(a){return a.macd},f=ga(),g=ga(),h=aa(),i=S(),j=x,k=function(a){f.xValue(d).yValue(function(a,b){return e(a).macd}),g.xValue(d).yValue(function(a,b){return e(a).signal}),h.xValue(d).yValue(function(a,b){return e(a).divergence}),i.xScale(b).yScale(c).series([h,f,g]).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi "+["macd-divergence","macd","macd-signal"][b]}),j(a,b,c)}),a.call(i)};return k.xScale=function(a){return arguments.length?(b=a,k):b},k.xValue=function(a){return arguments.length?(d=a,k):d},k.yScale=function(a){return arguments.length?(c=a,k):c},k.root=function(a){return arguments.length?(e=a,k):e},k.decorate=function(a){return arguments.length?(j=a,k):j},k}function Ba(){var b=a.time.scale(),c=a.scale.linear(),d=function(a,b){return a.close},e=function(a,b){return a.date},f=function(a){return a.bollingerBands},g=x,h=ka().y0Value(function(a,b){return f(a).upper}).y1Value(function(a,b){return f(a).lower}),i=ga().yValue(function(a,b){return f(a).upper}),j=ga().yValue(function(a,b){return f(a).average}),k=ga().yValue(function(a,b){return f(a).lower}),l=function(a){var d=S().xScale(b).yScale(c).series([h,i,k,j]).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi bollinger "+["area","upper","lower","average"][b]}),g(a,b,c)});h.xValue(e),i.xValue(e),j.xValue(e),k.xValue(e),a.call(d)};return l.xScale=function(a){return arguments.length?(b=a,l):b},l.yScale=function(a){return arguments.length?(c=a,l):c},l.xValue=function(a){return arguments.length?(e=a,l):e},l.yValue=function(a){return arguments.length?(d=a,l):d},l.root=function(a){return arguments.length?(f=a,l):f},l.decorate=function(a){return arguments.length?(g=a,l):g},l}function Ca(){var a=9,b=v,c=function(c){var d,e=2/(a+1),f=0;return c.map(function(c,g){if(a-1>g)return void(f+=b(c,g));if(g===a-1){f+=b(c,g);var h=f/a;return d=h,h}var i=b(c,g)*e+(1-e)*d;return d=i,i})};return c.windowSize=function(b){return arguments.length?(a=b,c):a},c.value=function(a){return arguments.length?(b=a,c):b},c}function Da(){var c=v,d=function(a,b){return a.high},e=function(a,b){return a.low},f=Ca().windowSize(13),g=function(b){f.value(c);var g=f(b),h=a.zip(b,g).map(function(a){return{bullPower:a[1]?d(a[0])-a[1]:void 0,bearPower:a[1]?e(a[0])-a[1]:void 0}});return h};return g.value=function(a){return arguments.length?(c=a,g):c},g.highValue=function(a){return arguments.length?(d=a,g):d},g.lowValue=function(a){return arguments.length?(e=a,g):d},b(g,f,{period:"windowSize"}),g}function Ea(){var b=a.functor(void 0),c=a.functor(10),d=x,e=v,f=function(a){var f=c.apply(this,arguments),g=a.slice(0,f).map(e);return a.map(function(a,c){
...
function Fa(){var b=x,c=Ea(),d=function(d){return a.zip(d,c(d)).forEach(function(a){b(a[0],a[1])})};return d.algorithm=function(a){return arguments.length?(c=a,d):c},d.merge=function(a){return arguments.length?(b=a,d):b},d}function Ga(){var b=Da().value(function(a){return a.close}),c=Fa().algorithm(b).merge(function(a,b){a.elderRay=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"highValue","lowValue","period","value"),d}function Ha(){var b=.1,c=v,d=function(a){return a.map(function(a){return{lower:c(a)*(1-b),upper:c(a)*(1+b)}})};return d.factor=function(a){return arguments.length?(b=a,d):b},d.value=function(b){return arguments.length?(c=a.functor(b),d):c},d}
...
function Ia(){function b(a){return Array.apply(null,new Array(a)).map(d)}var c=Ea().accumulator(a.mean),d=a.functor(void 0),e=function(a){return null==c.value()(a)},f=function(a){for(var d=0;e(a[d])&&d<a.length;)d++;var f=a.slice(d);return b(d).concat(c(f))};return f.algorithm=function(a){return arguments.length?(c=a,f):c},f.undefinedValue=function(b){return arguments.length?(d=a.functor(b),f):d},f.defined=function(a){return arguments.length?(e=a,f):e},f}function Ja(){var b=Ha(),c=Ia().undefinedValue({lower:void 0,upper:void 0}).algorithm(b),d=Fa().algorithm(c).merge(function(a,b){a.envelope=b}),e=function(a){return d(a)};return e.root=function(a){return a.envelope},a.rebind(e,d,"merge"),a.rebind(e,b,"value","factor"),e}function Ka(){var b=function(a,b){return a.volume},c=function(a,b){return a.close},d=Ea().windowSize(2).accumulator(function(a){return(c(a[1])-c(a[0]))*b(a[1])}),e=function(a){return d(a)};return e.volumeValue=function(a){return arguments.length?(b=a,e):b},e.closeValue=function(a){return arguments.length?(c=a,e):c},a.rebind(e,d,"windowSize"),e}function La(){var b=Ka(),c=Fa().algorithm(b).merge(function(a,b){a.force=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","volumeValue","closeValue"),d}function Ma(){var c=function(a,b){return a.close},d=function(a,b){return a.high},e=function(a,b){return a.low},f=Ea().windowSize(5).accumulator(function(b){var f=a.max(b,d),g=a.min(b,e);return 100*(c(b[b.length-1])-g)/(f-g)}),g=Ea().windowSize(3).accumulator(function(b){return void 0!==b[0]?a.mean(b):void 0}),h=function(a){var b=f(a),c=g(b);return b.map(function(a,b){var d=c[b];return{k:a,d:d}})};return h.closeValue=function(a){return arguments.length?(c=a,h):c},h.highValue=function(a){return arguments.length?(d=a,h):d},h.lowValue=function(a){return arguments.length?(e=a,h):d},b(h,f,{kWindowSize:"windowSize"}),b(h,g,{dWindowSize:"windowSize"}),h}function Na(){var b=Ma(),c=Fa().algorithm(b).merge(function(a,b){a.stochastic=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"kWindowSize","dWindowSize","lowValue","closeValue","highValue"),d}function Oa(){var b,c,d,e=function(a,b){return a.close},f=function(a,b){var c=b+(a[a.length-1]-b)/a.length;return c},g=function(a,b){return a+b},h=Ea().windowSize(14).accumulator(function(a){var h=a.map(e);if(!b)return void(b=h[0]);var i=[],j=[];h.forEach(function(a){var c=b>a?b-a:0,d=a>b?a-b:0;i.push(c),j.push(d),b=a});var k=c?f(i,c):i.reduce(g)/h.length,l=d?f(j,d):j.reduce(g)/h.length;c=k,d=l;var m=l/k;return 100-100/(1+m)}),i=function(a){return h(a)};return i.closeValue=function(a){return arguments.length?(e=a,i):e},a.rebind(i,h,"windowSize"),i}function Pa(){var b=Oa(),c=Fa().algorithm(b).merge(function(a,b){a.rsi=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","closeValue"),d}function Qa(){var b=Ea().accumulator(a.mean).value(function(a){return a.close}),c=Fa().algorithm(b).merge(function(a,b){a.movingAverage=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","undefinedValue","value"),d}function Ra(){var c=v,d=Ca().windowSize(12),e=Ca().windowSize(29),f=Ca().windowSize(9),g=Ia().algorithm(f),h=function(b){d.value(c),e.value(c);var f=a.zip(d(b),e(b)).map(function(a){return void 0!==a[0]&&void 0!==a[1]?a[0]-a[1]:void 0}),h=g(f);return a.zip(f,h).map(function(a){return{macd:a[0],signal:a[1],divergence:void 0!==a[0]&&void 0!==a[1]?a[0]-a[1]:void 0}})};return h.value=function(a){return arguments.length?(c=a,h):c},b(h,d,{fastPeriod:"windowSize"}),b(h,e,{slowPeriod:"windowSize"}),b(h,f,{signalPeriod:"windowSize"}),h}function Sa(){var b=Ra().value(function(a){return a.close}),c=Fa().algorithm(b).merge(function(a,b){a.macd=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"fastPeriod","slowPeriod","signalPeriod","value"),d}function Ta(){var b=Ca().value(function(a){return a.close}),c=Fa().algorithm(b).merge(function(a,b){a.exponentialMovingAverage=b}),d=function(a){return c(a)};return a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","value"),d}function Ua(){var b=a.functor(0),c=v,d=function(a){if(0===a.length)return[];var d=c(a[b(a)]);return a.map(function(a,b){return(c(a,b)-d)/d})};return d.baseIndex=function(c){return arguments.length?(b=a.functor(c),d):b},d.value=function(a){return arguments.length?(c=a,d):c},d}function Va(){var b=2,c=Ea().undefinedValue({upper:void 0,average:void 0,lower:void 0}).accumulator(function(c){var d=a.mean(c),e=a.deviation(c);return{upper:d+b*e,average:d,lower:d-b*e}}),d=function(a){return c(a)};return d.multiplier=function(a){return arguments.length?(b=a,d):b},a.rebind(d,c,"windowSize","value"),d}function Wa(){var b=Va().value(function(a){return a.close}),c=Fa().algorithm(b).merge(function(a,b){a.bollingerBands=b}),d=function(a){return c(a)};return d.root=function(a){return a.bollingerBands},a.rebind(d,c,"merge"),a.rebind(d,b,"windowSize","value","multiplier"),d}function Xa(){var a=10,b=function(b){for(var c=Math.ceil(b.length/a),d=[],e=0;c>e;e++)d.push(b.slice(e*a,(e+1)*a));return d};return b.bucketSize=function(c){return arguments.length?(a=c,b):a},b}function Ya(){function b(a){for(var b=a.map(function(a){return[d(a),e(a)]}),c=[],f=1;f<b.length-1;f++){var g=b[f-1],h=b[f],i=b[f+1],j=(g[0]-i[0])*(h[1]-g[1]),k=(g[0]-h[0])*(i[1]-g[1]),l=Math.abs(.5*j*k);c.push(l)}return c}var c=Xa(),d=v,e=v,f=function(d){if(c.bucketSize()>=d.length)return d;var e=b(d),f=c(e),g=c(d.slice(1,d.length-1)),h=g.map(function(b,c){var d=f[c],e=a.max(d),g=d.indexOf(e);return b[g]});
// First and last data points are their own buckets.
return[].concat(d[0],h,d[d.length-1])};return a.rebind(f,c,"bucketSize"),f.x=function(a){return arguments.length?(d=a,f):d},f.y=function(a){return arguments.length?(e=a,f):e},f}function Za(){var b=v,c=v,d=Xa(),e=function(e){if(d.bucketSize()>=e.length)return e;var f=d(e.slice(1,e.length-1)),g=e[0],h=e[e.length-1],i=[].concat(g,f,h),j=b(g),k=c(g),l=f.map(function(d,e){for(var f,g=-(1/0),h=a.mean(i[e+1],b),l=a.mean(i[e+1],c),m=0;m<d.length;m++){var n=b(d[m]),o=c(d[m]),p=(j-h)*(o-k),q=(j-n)*(l-k),r=Math.abs(.5*p*q);r>g&&(g=r,f=d[m])}return j=b(f),k=c(f),f});
// First and last data points are their own buckets.
return[].concat(e[0],l,e[e.length-1])};return a.rebind(e,d,"bucketSize"),e.x=function(a){return arguments.length?(b=a,e):b},e.y=function(a){return arguments.length?(c=a,e):c},e}function $a(){var b=Xa(),c=v,d=function(d){if(b.bucketSize()>d.length)return d;var e=a.extent(d),f=b(d.slice(1,d.length-1)),g=f.map(function(a,b){for(var d,f,g={},h=!0,i=0;i<a.length;i++){var j=c(a[i]);if(j===e[0]||j===e[1])return a[i];void 0===g[j]&&(g[j]=0),g[j]++,g[j]>g[d]||void 0===d?(d=j,f=i,h=!0):g[j]===g[d]&&(h=!1)}return h?a[f]:a[Math.floor(a.length/2)]});
// First and last data points are their own buckets.
...
function eb(){var b="BTC-USD",c=null,d=null,e=null,f=function(f){var g=[];null!=c&&g.push("start="+c.toISOString()),null!=d&&g.push("end="+d.toISOString()),null!=e&&g.push("granularity="+e);var h="https://api.exchange.coinbase.com/products/"+b+"/candles?"+g.join("&");a.json(h,function(a,b){return a?void f(a):(b=b.map(function(a){return{date:new Date(1e3*a[0]),open:a[3],high:a[2],low:a[1],close:a[4],volume:a[5]}}),void f(a,b))})};return f.product=function(a){return arguments.length?(b=a,f):b},f.start=function(a){return arguments.length?(c=a,f):c},f.end=function(a){return arguments.length?(d=a,f):d},f.granularity=function(a){return arguments.length?(e=a,f):e},f}function fb(b,c){function e(a){return y().selector("g."+a).element("g").attr("class",a)}b=b||a.scale.linear(),c=c||a.scale.linear();var f=10,g=9,h=x,i=ga(),j={bottom:30,right:30},k=function(a){return a.values},l=function(a){return a.key},m=$().ticks(2),n=$().orient("right").ticks(3),o=e("multiple"),p=e("x-axis"),q=e("y-axis"),r=function(d){d.each(function(d,e){function r(a,b){return{xOffset:(x+f)*a,yOffset:(y+f)*b}}var s=a.select(this),t=N(j);t.position="absolute";var u=s.selectAll("svg").data([d]);u.enter().append("svg").layout("flex",1).append("g").attr("class","multiples-chart");var v=u.select("g").layout(t);s.layout();var w=Math.ceil(d.length/g),x=v.layout("width")/g-f,y=v.layout("height")/w-f;B(b,[0,x]),B(c,[y,0]),i.xScale(b).yScale(c);
...
z.select("g").datum(k).call(i),z.select("rect").attr({width:x,height:y}),h(z,d,e);var C=p(v,a.range(g));C.attr("transform",function(a,b){var c="bottom"===m.orient()?w:0,d="bottom"===m.orient()?0:-f,e=r(b,c);return"translate("+e.xOffset+","+(e.yOffset+d)+")"}),m.scale(b),C.call(m);var D=q(v,a.range(w));D.attr("transform",function(a,b){var c="left"===n.orient()?0:g,d="left"===n.orient()?-f:0,e=r(c,b);return"translate("+(e.xOffset+d)+","+e.yOffset+")"}),n.scale(c),D.call(n)})},s=[/range\w*/,// the scale range is set via the component layout
/tickFormat/];return d(r,b,"x",s),d(r,c,"y",s),d(r,m,"x"),d(r,n,"y"),r.columns=function(a){return arguments.length?(g=a,r):g},r.margin=function(a){return arguments.length?(j=a,r):j},r.padding=function(a){return arguments.length?(f=a,r):f},r.plotArea=function(a){return arguments.length?(i=a,r):i},r.values=function(a){return arguments.length?(k=a,r):k},r.key=function(a){return arguments.length?(l=a,r):l},r.decorate=function(a){return arguments.length?(h=a,r):h},r}function gb(){var b=50,c=x,d=[["datum:",function(a){return a.datum}]],e=y().selector("g.cell").element("g").attr("class","cell tooltip"),f=function(f){f.each(function(f,g){var h=a.select(this),i=d.map(function(b,c){return{datum:f,label:a.functor(b[0]),value:a.functor(b[1])}}),j=e(h,i);j.enter().layout({flex:1,flexDirection:"row"}),j.enter().append("text").attr("class","label").layout("flex",b),j.enter().append("text").attr("class","value").layout("flex",100-b),j.select(".label").text(function(a,b){return a.label.call(this,a.datum,b)}),j.select(".value").text(function(a,b){return a.value.call(this,a.datum,b)}),c(j,f,g),h.layout()})};return f.decorate=function(a){return arguments.length?(c=a,f):c},f.split=function(a){return arguments.length?(b=a,f):b},f.items=function(a){return arguments.length?(d=a,f):d},f}function hb(){
// creates an array with four elements, representing the high, low, open and close
// values of the given array
function c(b){function c(a){return b.filter(function(b){return e(b)===a})[0]}var d=j.xValue(),e=j.yValue(),f=a.max(b,e),g=a.min(b,e);return[{x:d(b[0]),y:e(b[0])},{x:d(c(f)),y:f},{x:d(c(g)),y:g},{x:d(b[b.length-1]),y:e(b[b.length-1])}]}var d=ta(),e=a.scale.linear(),f=2,g=ga(),h=U().xValue(function(a){return a.x}).yValue(function(a){return a.y}).decorate(function(a){a.attr("class",function(a,b){switch(b){case 0:return"open";case 1:return"high";case 2:return"low";case 3:return"close"}})}),i=S().series([g,h]).mapping(function(a){switch(a){case h:return c(this);default:return this}}),j=function(b){h.size(f*f*Math.PI),b.each(function(b){var c=a.select(this),g=K(this),h=f;d.range([h,g.width-h]),e.range([g.height-h,h]),i.xScale(d).yScale(e),c.call(i)})};return b(j,d,{xDiscontinuityProvider:"discontinuityProvider",xDomain:"domain"}),b(j,e,{yDomain:"domain"}),b(j,g,"xValue","yValue"),j.xScale=function(){return d},j.yScale=function(){return e},j.radius=function(a){return arguments.length?(f=a,j):f},j}function ib(b,c){b=b||a.scale.linear(),c=c||a.scale.linear();var e={bottom:30,right:30},f="",g="",h=null,i=null,j="",k=ga(),l=x,m=pa().orient("bottom").baseline(function(){if(null!==h)return c(h.apply(this,arguments));var a=A(c);return"bottom"===m.orient()?a[0]:a[1]}),n=pa().orient("right").baseline(function(){if(null!==i)return b(i.apply(this,arguments));var a=A(b);return"left"===n.orient()?a[0]:a[1]}),o=y().selector("svg.cartesian-chart").element("svg").attr({"class":"cartesian-chart","layout-style":"flex: 1"}),p=function(d){d.each(function(d,h){var i=a.select(this),p=o(i,[d]);p.enter().html('<g class="plot-area-container">                     <rect class="background"                         layout-style="position: absolute; top: 0; bottom: 0; left: 0; right: 0"/>                     <g class="axes-container"                         layout-style="position: absolute; top: 0; bottom: 0; left: 0; right: 0">                         <g class="x-axis" layout-style="height: 0; width: 0"/>                         <g class="y-axis" layout-style="height: 0; width: 0"/>                     </g>                     <svg class="plot-area"                         layout-style="position: absolute; top: 0; bottom: 0; left: 0; right: 0"/>                 </g>                 <g class="x-axis label-container">                     <g layout-style="height: 0; width: 0">                         <text class="label"/>                     </g>                 </g>                 <g class="y-axis label-container">                     <g layout-style="height: 0; width: 0">                         <text class="label"/>                     </g>                 </g>                 <g class="title label-container">                     <g layout-style="height: 0; width: 0">                         <text class="label"/>                     </g>                 </g>');var q=N(e);p.select(".plot-area-container").layout({position:"absolute",top:q.top,left:q.left,bottom:q.bottom,right:q.right}),p.select(".title").layout({position:"absolute",top:0,alignItems:"center",left:q.left,right:q.right});var r={position:"absolute",top:q.top,bottom:q.bottom,alignItems:"center",flexDirection:"row"};r[n.orient()]=0,p.select(".y-axis.label-container").attr("class","y-axis label-container "+n.orient()).layout(r);var s={position:"absolute",left:q.left,right:q.right,alignItems:"center"};s[m.orient()]=0,p.select(".x-axis.label-container").attr("class","x-axis label-container "+m.orient()).layout(s),
...
// set the axis ranges
var t=p.select(".plot-area");B(b,[0,t.layout("width")]),B(c,[t.layout("height"),0]),
// render the axes
...
"xScale","yScale"];return d(p,m,"x",r),d(p,n,"y",r),p.xBaseline=function(b){return arguments.length?(h=a.functor(b),p):h},p.yBaseline=function(b){return arguments.length?(i=a.functor(b),p):i},p.chartLabel=function(a){return arguments.length?(j=a,p):j},p.plotArea=function(a){return arguments.length?(k=a,p):k},p.xLabel=function(a){return arguments.length?(g=a,p):g},p.margin=function(a){return arguments.length?(e=a,p):e},p.yLabel=function(a){return arguments.length?(f=a,p):f},p.decorate=function(a){return arguments.length?(l=a,p):l},p}function jb(){var c=a.time.scale(),d=a.scale.linear(),e=10,f=10,g=x,h=x,i=y().selector("line.x").element("line").attr("class","x gridline"),j=y().selector("line.y").element("line").attr("class","y gridline"),k=function(a){a.each(function(a,b){var k=c.ticks(e),l=i(this,k);l.attr({x1:c,x2:c,y1:d.range()[0],y2:d.range()[1]}),g(l,k,b);var m=d.ticks(f),n=j(this,m);n.attr({x1:c.range()[0],x2:c.range()[1],y1:d,y2:d}),h(n,m,b)})};return k.xScale=function(a){return arguments.length?(c=a,k):c},k.yScale=function(a){return arguments.length?(d=a,k):d},k.xTicks=function(a){return arguments.length?(e=a,k):e},k.yTicks=function(a){return arguments.length?(f=a,k):f},k.yDecorate=function(a){return arguments.length?(h=a,k):h},k.xDecorate=function(a){return arguments.length?(g=a,k):g},b(k,i,{xKey:"key"}),b(k,j,{yKey:"key"}),k}function kb(){var b,c,d,e,f=a.time.scale(),g=a.scale.linear(),h=function(){return A(f)[0]},i=function(){return A(f)[1]},j=function(){return A(g)[0]},k=function(){return A(g)[1]},l=x,m=y().selector("g.annotation").element("g").attr("class","annotation"),n=function(b){b.each(function(b,c){var d=a.select(this),e=m(d,b);e.enter().append("path").classed("band",!0);var f=Z().horizontalAlign("right").verticalAlign("top").x(h).y(j).height(function(){return k.apply(this,arguments)-j.apply(this,arguments)}).width(function(){return i.apply(this,arguments)-h.apply(this,arguments)});e.select("path").attr("d",function(a,b){
// the path generator is being used to render a single path, hence
// an explicit index is provided
return f.call(this,[a],b)}),l(e,b,c)})};return n.xScale=function(a){return arguments.length?(f=a,n):f},n.yScale=function(a){return arguments.length?(g=a,n):g},n.decorate=function(a){return arguments.length?(l=a,n):l},n.x0=function(c){return arguments.length?(b=a.functor(c),h=function(){return f(b.apply(this,arguments))},n):b},n.x1=function(b){return arguments.length?(c=a.functor(b),i=function(){return f(c.apply(this,arguments))},n):c},n.y0=function(b){return arguments.length?(d=a.functor(b),j=function(){return g(d.apply(this,arguments))},n):d},n.y1=function(b){return arguments.length?(e=a.functor(b),k=function(){return g(e.apply(this,arguments))},n):e},n}function lb(a){for(;a.ownerSVGElement;)a=a.ownerSVGElement;return a}
// parses the style attribute, converting it into a JavaScript object
function mb(a){if(!a)return{};var b=a.split(";"),c={};return b.forEach(function(a){var b=a.split(":");if(2===b.length){var d=b[0].trim(),e=b[1].trim();c[d]=isNaN(e)?e:Number(e)}}),c}
// creates the structure required by the layout engine
function nb(a){function b(){for(var b=[],c=0;c<a.childNodes.length;c++){var d=a.childNodes[c];1===d.nodeType&&d.getAttribute("layout-style")&&b.push(nb(d))}return b}return{style:mb(a.getAttribute("layout-style")),children:b(a),element:a}}
...
!c&&b&&a.element.setAttribute("transform","translate("+a.layout.left+", "+a.layout.top+")"),a.children.forEach(function(a){ob(a,!0)})}function pb(a){return a.hasAttribute("layout-width")&&a.hasAttribute("layout-height")?{width:Number(a.getAttribute("layout-width")),height:Number(a.getAttribute("layout-height"))}:K(a)}function qb(a){return a.hasAttribute("layout-x")&&a.hasAttribute("layout-y")?{x:Number(a.getAttribute("layout-x")),y:Number(a.getAttribute("layout-y"))}:{x:0,y:0}}function rb(a){if("suspended"!==lb(a).__layout__){var b=pb(a),c=qb(a),d=nb(a);
...
ob(d)}}function sb(a){return arguments.length?this.each(function(){lb(this).__layout__=a?"suspended":""}):Boolean(lb(this.node()).__layout__)}function tb(a,b){var c=arguments.length;
...
this.setAttribute("layout-width",a),this.setAttribute("layout-height",b),rb(this)):
...
var d=mb(this.getAttribute("layout-style")),e=a;Object.keys(e).forEach(function(a){d[a]=e[a]});var f=Object.keys(d).map(function(a){return a+":"+d[a]}).join(";");this.setAttribute("layout-style",f)}}else 0===c&&
// layout() - executes layout
rb(this)})}function ub(){return++Sc}function vb(a,b){function c(b){return a.secondaries.filter(function(a,c){return c===b})}for(var d=0,e=0;e<b.secondaries.length;e++)b.secondaries[e]&&d++;a.secondaries.filter(function(a,b){return d>b}).style("flex","1"),a.secondaries.filter(function(a,b){return b>=d}).style("flex","0"),a.overlaySecondaries.filter(function(a,b){return d>b}).style("flex","1"),a.overlaySecondaries.filter(function(a,b){return b>=d}).style("flex","0");var f=parseInt(a.app.select(".head-row").style("height"),10);Tc||(f+=parseInt(a.app.select(".head-row").style("padding-top"),10)+parseInt(a.app.select(".head-row").style("padding-bottom"),10)+parseInt(a.app.select(".head-row").style("margin-bottom"),10),Tc=!0);var g=window.innerHeight-f;a.charts.style("height",g+"px"),b.xAxis.dimensionChanged(a.xAxis),b.navbar.dimensionChanged(a.navbar),b.primary.dimensionChanged(a.primary);for(var h=0;h<b.secondaries.length;h++)b.secondaries[h].option.dimensionChanged(c(h))}function wb(b,c){var d=a.max(b,function(a){return a.getTime()}),e=a.max(c,function(a){return a.date.getTime()});return d===e}function xb(a,b){var c=Array.isArray(b)?b:[b,b],d=a[1]-a[0];return[a[0]-d*c[0],a[1]+d*c[1]]}function yb(b,c,d){arguments.length<3&&(d=1);var e=Rc.util.extent().fields("date")(c),f=(e[1].getTime()-e[0].getTime())/1e3,g=b.map(function(a){return a.getTime()}),h=d*(a.max(g)-a.min(g))/1e3,i=f>h?[a.time.second.offset(e[1],-h),e[1]]:e;return i}function zb(b,c){var d=a.min(b,function(a){return a.getTime()}),e=a.max(b,function(a){return a.getTime()}),f=c.sort(function(a,b){return a.date-b.date}),g=a.bisector(function(a){return a.date}),h=c.slice(
// Pad and clamp the bisector values to ensure extents can be calculated
Math.max(0,g.left(f,d)-1),Math.min(g.right(f,e)+1,f.length));return h}function Ab(b,c,d){var e=Rc.util.extent().fields("date")(c),f=b.map(function(a){return a.getTime()}),g=(a.max(f)-a.min(f))/1e3;if(d.getTime()<e[0]||d.getTime()>e[1])return[new Date(a.min(f)),new Date(a.max(f))];var h=[a.time.second.offset(d,-g/2),a.time.second.offset(d,g/2)],i=0;return h[1].getTime()>e[1].getTime()?i=(e[1].getTime()-h[1].getTime())/1e3:h[0].getTime()<e[0].getTime()&&(i=(e[0].getTime()-h[0].getTime())/1e3),[a.time.second.offset(h[0],i),a.time.second.offset(h[1],i)]}function Bb(b){function c(a){
// Don't pan off sides
// Don't pan off sides
return a[0]>=0?-a[0]:a[1]<=0?-a[1]:0}function d(a){
// If zooming, and about to pan off screen, do nothing
return a[0]>0&&a[1]<0}function e(a){var b=j.translate()[0];b+=a,j.translate([b,0])}function f(){j.translate([0,0]),j.scale(1)}function g(a){var g=Rc.util.extent().fields("date")(a.datum().data);j.x(h).on("zoom",function(){var n=h(g[0]),o=h(g[1]),p=d([n,o-b]),q=c([n,o-b]);e(q);var r=1===j.scale(),s=1!==j.scale();if(r&&k||s&&l){var t=h.domain();p?t=g:s&&m&&(t=Vc.domain.moveToLatest(t,a.datum().data)),t[0].getTime()!==t[1].getTime()?i.zoom(t):
// Ensure the user can't zoom-in infinitely, causing the chart to fail to render
// #168, #411
f()}else f()}),a.call(j)}var h,i=a.dispatch("zoom"),j=a.behavior.zoom(),k=!0,l=!0,m=!0;return g.allowPan=function(a){return arguments.length?(k=a,g):k},g.allowZoom=function(a){return arguments.length?(l=a,g):l},g.trackingLatest=function(a){return arguments.length?(m=a,g):m},g.scale=function(a){return arguments.length?(h=a,g):h},a.rebind(g,i,"on"),g}function Cb(){function b(b){b.each(function(f){var h=a.select(this).call(j),i=Bb(c).scale(e).trackingLatest(g).on("zoom",function(a){d[Wc.viewChange](a)});h.select(".plot-area-container").datum({data:b.datum()}).call(i)})}var c,d=a.dispatch(Wc.viewChange),e=Rc.scale.dateTime(),f=a.scale.linear(),g=!0,h=60,i=Rc.series.multi(),j=Rc.chart.cartesian(e,f).plotArea(i).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:h});return b.trackingLatest=function(a){return arguments.length?(g=a,b):g},a.rebind(b,d,"on"),a.rebind(b,i,"series","mapping","decorate"),a.rebind(b,j,"yTickValues","yTickFormat","yTicks","xDomain","yDomain"),b.dimensionChanged=function(a){c=parseInt(a.style("width"),10)-h},b}function Db(){function b(a){a.each(function(b){var c=Rc.util.extent().fields("volume").pad(.08)(b.data);c[0]<0&&(c[0]=0),e.yTickFormat(b.product.volumeFormat).trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain(c),a.datum(b.data).call(e)})}var c=a.dispatch(Wc.viewChange),d=Rc.series.bar().yValue(function(a){return a.volume}),e=Cb().series([d]).yTicks(4).on(Wc.viewChange,function(a){c[Wc.viewChange](a)});return a.rebind(b,c,"on"),b.dimensionChanged=function(a){e.dimensionChanged(a)},b}function Eb(){function b(a){var b=a.datum();e(b.data),g.trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain([0,100]),a.datum(b.data).call(g)}var c=a.dispatch(Wc.viewChange),d=Rc.indicator.renderer.relativeStrengthIndex(),e=Rc.indicator.algorithm.relativeStrengthIndex(),f=[d.lowerValue(),50,d.upperValue()],g=Cb().series([d]).yTickValues(f).on(Wc.viewChange,function(a){c[Wc.viewChange](a)});return a.rebind(b,c,"on"),b.dimensionChanged=function(a){g.dimensionChanged(a)},b}function Fb(){function b(a){var b=a.datum();f(b.data);var c=Rc.util.extent().fields("macd").symmetricalAbout(0).pad(.08)(b.data.map(function(a){return a.macd}));g.trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain(c),a.datum(b.data).call(g)}var c=a.dispatch(Wc.viewChange),d=Rc.annotation.line().value(0).label(""),e=Rc.indicator.renderer.macd(),f=Rc.indicator.algorithm.macd(),g=Cb().series([d,e]).yTicks(5).mapping(function(a){return a===d?[0]:this}).decorate(function(a){a.enter().attr("class",function(a,b){return["multi zero","multi"][b]})}).on(Wc.viewChange,function(a){c[Wc.viewChange](a)});return a.rebind(b,c,"on"),b.dimensionChanged=function(a){g.dimensionChanged(a)},b}function Gb(){function b(a){var b=(d.ticks()[1]-d.ticks()[0])/1e3;b<a.seconds?e.ticks(a.d3TimeInterval.unit,a.d3TimeInterval.value):e.ticks(6)}function c(a){var c=a.datum();d.domain(c.viewDomain),b(c.period),a.call(e)}var d=Rc.scale.dateTime(),e=a.svg.axis().scale(d).orient("bottom");return c.dimensionChanged=function(a){d.range([0,parseInt(a.style("width"),10)])},c}function Hb(a,b,c,d){return{displayString:a,// TODO: is 'displayName' better?
valueString:b,// TODO: is this an id?
option:c,// TODO: Ideally, remove.
isSelected:!1,icon:d}}function Ib(){var b=Rc.scale.dateTime(),c=a.scale.linear(),d=Rc.util.fractionalBarWidth(.75),e=function(a,b){return a.date},f=function(a,c){return b(e(a,c))},g=function(a){return a.low},h=function(a){return a.high},i=function(a,b){return a.close},j=Rc.svg.candlestick().x(function(a){return b(a.date)}).open(function(a){return c(a.open)}).high(function(a){return c(h(a))}).low(function(a){return c(g(a))}).close(function(a){return c(a.close)}),k=Rc.util.dataJoin().selector("path.up").element("path").attr("class","up"),l=Rc.util.dataJoin().selector("path.down").element("path").attr("class","down"),m=function(a){a.each(function(a){j.width(d(a.map(f)));var b=a.filter(function(a){return a.open<a.close}),c=a.filter(function(a){return a.open>=a.close});k(this,[b]).attr("d",j),l(this,[c]).attr("d",j)})};return m.xScale=function(a){return arguments.length?(b=a,m):b},m.yScale=function(a){return arguments.length?(c=a,m):c},m.xValue=function(a){return arguments.length?(e=a,m):e},m.yLowValue=function(a){return arguments.length?(g=a,m):g},m.yHighValue=function(a){return arguments.length?(h=a,m):h},m.yCloseValue=function(a){return arguments.length?(i=a,m):i},m.width=function(a){return d(a.map(f))},m}function Jb(a,b){var c=b/2;return[[0,0],[c,-c],[a,-c],[a,c],[c,c],[0,0]]}function Kb(a,b){for(var c=a.ticks.apply(a,[]),d=a.domain(),e=0;e<b.length;e++)b[e]>d[0]&&b[e]<d[1]&&c.push(b[e]);return c}function Lb(b,c,d){var e;switch(c.valueString){case"candlestick":case"ohlc":e=[c.option.yLowValue(),c.option.yHighValue()];break;case"line":case"point":e=c.option.yValue();break;case"area":e=c.option.y1Value();break;default:throw new Error("Main series given to chart does not have expected interface")}var f=Rc.util.extent().fields(e)(b);if(d.length){var g=d.map(function(a){return a.valueString}),h=-1!==g.indexOf("movingAverage"),i=-1!==g.indexOf("bollinger");if(i){var j=b.map(function(a){return a.bollingerBands}),k=Rc.util.extent().fields(["lower","upper"])(j);f[0]=a.min([k[0],f[0]]),f[1]=a.max([k[1],f[1]])}if(h){var l=Rc.util.extent().fields("movingAverage")(b);f[0]=a.min([l[0],f[0]]),f[1]=a.max([l[1],f[1]])}if(!h&&!i)throw new Error("Unexpected indicator type")}return f}function Mb(){function b(){var a=[q,i.option,r],b=n.map(function(a){return a.option});return a.concat(b,p)}function c(){switch(w.value(m),x.value(m),r.value(m),i.valueString){case"line":case"point":case"area":i.option.yValue(m)}}
// Call when what to display on the chart is modified (ie series, options)
function d(a){i=a.series,m=a.yValueAccessor.option,n=a.indicators,c(),s.series(b()),v.yTickFormat(a.product.priceFormat),a.selectorsChanged=!1}function e(a){var b=i.option.width(a);p.decorate(function(a){a.classed("band hidden-xs hidden-sm",!0),a.selectAll(".vertical > line").style("stroke-width",b)})}function f(a){a.classed("band",!1).classed("hidden-xs hidden-sm",!0).selectAll("line").style("stroke-width",null)}function g(a){"candlestick"===i.valueString||"ohlc"===i.valueString?e(a):p.decorate(f)}function h(b){var c=b.datum();c.selectorsChanged&&d(c),v.xDomain(c.viewDomain),p.snap(Rc.util.seriesPointSnapXOnly(i.option,c.data)),g(c.data),w(c.data),x(c.data);
// Scale y axis
var e=Vc.domain.filterDataInDateRange(v.xDomain(),c.data),f=Lb(e,i,n),h=Vc.domain.padYDomain(f,.04);v.yDomain(h);
// Find current tick values and add close price to this list, then set it explicitly below
var o=m(c.data[c.data.length-1]),q=Kb(u,[o]);v.yTickValues(q).yDecorate(function(b){b.selectAll(".tick").filter(function(a){return a===o}).classed("closeLine",!0).select("path").attr("d",function(b){return a.svg.area()(Jb(k,14))})}),
// Redraw
v.plotArea(s),b.call(v);var r=Bb(j).scale(t).trackingLatest(c.trackingLatest).on("zoom",function(a){l[Wc.viewChange](a)});b.select(".plot-area").call(r)}var i,j,k=60,l=a.dispatch(Wc.viewChange,Wc.crosshairChange),m=function(a){return a.close},n=[],o=[],p=Rc.tool.crosshair().xLabel("").yLabel("").on("trackingmove",function(a){a.length>0?l.crosshairChange(a[0].datum):l.crosshairChange(void 0)}).on("trackingend",function(){l.crosshairChange(void 0)});p.id=Vc.uid();var q=Rc.annotation.gridline().yTicks(5).xTicks(0),r=Rc.annotation.line().orient("horizontal").value(m).label("");r.id=Vc.uid();var s=Rc.series.multi().key(function(a){return a.id}).mapping(function(a){switch(a){case r:return[this.data[this.data.length-1]];case p:return o;default:return this.data}}),t=Rc.scale.dateTime(),u=a.scale.linear(),v=Rc.chart.cartesian(t,u).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:k}),w=Rc.indicator.algorithm.movingAverage(),x=Rc.indicator.algorithm.bollingerBands();
// Call when the main layout is modified
return a.rebind(h,l,"on"),h.dimensionChanged=function(a){j=parseInt(a.style("width"),10)-k},h}function Nb(){function b(a,b){a.select(".plot-area").selectAll(".e, .w").classed("hidden",b)}function c(a){return a.extent()[0][0]-a.extent()[1][0]===0}function d(a){var d=a.datum();q.domain(d.viewDomain);var f=Vc.domain.filterDataInDateRange(Rc.util.extent().fields("date")(d.data),d.data),g=Rc.util.extent().fields(["low","high"])(f);p.xDomain(Rc.util.extent().fields("date")(d.data)).yDomain(g),t.on("brush",function(){var d=c(t);
// Hide the bar if the extent is empty
b(a,d),d||o[Wc.viewChange]([t.extent()[0][0],t.extent()[1][0]])}).on("brushend",function(){var e=c(t);b(a,!1),e&&o[Wc.viewChange](Vc.domain.centerOnDate(q.domain(),d.data,t.extent()[0][0]))}),p.plotArea(u),a.call(p);
// Allow to zoom using mouse, but disable panning
var h=Bb(e).scale(q).trackingLatest(d.trackingLatest).allowPan(!1).on("zoom",function(a){o[Wc.viewChange](a)});a.select(".plot-area").call(h)}var e,f=100,g=40,h=f-g,i=2,j=i/2,k=h-j,l=k,m=j+l/2,n=2,o=a.dispatch(Wc.viewChange),p=Rc.chart.cartesian(Rc.scale.dateTime(),a.scale.linear()).yTicks(0).margin({bottom:g}),q=Rc.scale.dateTime(),r=Rc.series.area().yValue(function(a){return a.close}),s=Rc.series.line().yValue(function(a){return a.close}),t=a.svg.brush(),u=Rc.series.multi().series([r,s,t]).decorate(function(a){var b=a.enter();a.select(".extent").attr("height",k).attr("y",i/2),
...
var c=b.selectAll(".e, .w");c.append("circle").attr("cy",m).attr("r",7).attr("class","outer-handle"),c.append("circle").attr("cy",m).attr("r",4).attr("class","inner-handle")}).mapping(function(a){return a!==t?this.data:void t.extent([[q.domain()[0],p.yDomain()[0]],[q.domain()[1],p.yDomain()[1]]])});return a.rebind(d,o,"on"),d.dimensionChanged=function(a){e=parseInt(a.style("width"),10),q.range([0,e])},d}function Ob(){function b(b){b.each(function(b){var h=a.select(this);if(c=b.product.priceFormat,d=b.product.volumeFormat,e=b.period.timeFormat,null==b.data||b.data!==f){f=b.data;var i=h.selectAll("span").data(g);i.enter().append("span").attr("class",function(a,b){return b%2===0?"legendLabel":"legendValue"}),i.text(function(a,c){var d="";return c%2===0?a:b.data?a(b.data):d})}})}var c,d,e,f,g=["T",function(a){return e(a.date)},"O",function(a){return c(a.open)},"H",function(a){return c(a.high)},"L",function(a){return c(a.low)},"C",function(a){return c(a.close)},"V",function(a){return d(a.volume)}];return b}function Pb(a,b){return{historic:a,streaming:b}}function Qb(b){return{id:b.id,display:b.display||"Unspecified Product",priceFormat:a.format(b.priceFormat||".2f"),volumeFormat:a.format(b.volumeFormat||".2f"),periods:b.periods||[],source:b.source}}function Rb(b){return b=b||{},{display:b.display||"1 day",seconds:b.seconds||86400,d3TimeInterval:b.d3TimeInterval||{unit:a.time.day,value:1},timeFormat:a.time.format(b.timeFormat||"%b %d")}}function Sb(a){return{viewDomain:[],period:a}}function Tb(a){return{data:[],viewDomain:[],trackingLatest:!0,product:a}}function Ub(a){var b={data:[],trackingLatest:!0,viewDomain:[],selectorsChanged:!0},c=a;Object.defineProperty(b,"product",{get:function(){return c},set:function(a){c=a,b.selectorsChanged=!0}});var d=Ib();d.id=Vc.uid();var e=Hb("Candlestick","candlestick",d);Object.defineProperty(b,"series",{get:function(){return e},set:function(a){e=a,b.selectorsChanged=!0}});var f={option:function(a){return a.close}};Object.defineProperty(b,"yValueAccessor",{get:function(){return f},set:function(a){f=a,b.selectorsChanged=!0}});var g=[];return Object.defineProperty(b,"indicators",{get:function(){return g},set:function(a){g=a,b.selectorsChanged=!0}}),b}function Vb(){return{trackingLatest:!0}}function Wb(){return{data:[],viewDomain:[],trackingLatest:!0}}function Xb(a,b){return{data:void 0,product:a,period:b}}function Yb(){return{primaryIndicators:[],secondaryIndicators:[]}}
// Generates a menu option similar to those generated by sc.model.menu.option from a sc.model.data.product object
function Zb(a){return{displayString:a.display,option:a}}
// Generates a menu option similar to those generated by model.menu.option from a model.data.period object
function $b(a){return{displayString:a.display,option:a}}function _b(a,b,c){return{productConfig:{title:null,careted:!0,listIcons:!1,icon:!1},mobilePeriodConfig:{title:null,careted:!1,listIcons:!1,icon:!1},products:a,selectedProduct:b,selectedPeriod:c}}function ac(){var a=Ib();a.id=Vc.uid();var b=Hb("Candlestick","candlestick",a,"sc-icon-candlestick-series");b.isSelected=!0;var c=Rc.series.ohlc();c.id=Vc.uid();var d=Rc.series.line();d.id=Vc.uid();var e=Rc.series.point();e.id=Vc.uid();var f=Rc.series.area();return f.id=Vc.uid(),{config:{title:null,careted:!1,listIcons:!0,icon:!0},options:[b,Hb("OHLC","ohlc",c,"sc-icon-ohlc-series"),Hb("Line","line",d,"sc-icon-line-series"),Hb("Point","point",e,"sc-icon-point-series"),Hb("Area","area",f,"sc-icon-area-series")]}}function bc(){return{config:{title:"Add Indicator",careted:!1,listIcons:!0,icon:!1},indicatorOptions:bd,secondaryChartOptions:cd}}function cc(){
// TODO: Instantiate series/indicator components outside of menu model?
return{seriesSelector:ac(),indicatorSelector:bc()}}function dc(){function b(b){var g=a.time.second.offset(e.end(),-d*c);e.apiKey("kM9Z9aEULVDD7svZ4A8B"),e.start(g).collapse(f.get(c)),e(b)}var c,d,e=Rc.data.feed.quandl(),f=a.map();return f.set(86400,"daily"),f.set(604800,"weekly"),b.candles=function(a){return arguments.length?(d=a,b):d},b.granularity=function(a){if(!arguments.length)return c;if(!f.has(a))throw new Error("Granularity of "+a+" is not supported.");return c=a,b},Rc.util.rebind(b,e,{end:"end",product:"dataset"}),b}
// https://docs.exchange.coinbase.com/#websocket-feed
function ec(){var b,c="BTC-USD",d=a.dispatch("open","close","error","message"),e="match",f=function(a,f){a=a||"wss://ws-feed.exchange.coinbase.com",f=f||{type:"subscribe",product_id:c},b=new WebSocket(a),b.onopen=function(a){b.send(JSON.stringify(f)),d.open(a)},b.onerror=function(a){d.error(a)},b.onclose=function(a){d.close(a)},b.onmessage=function(a){var b=JSON.parse(a.data);b.type===e?d.message(b):"error"===b.type&&d.error(b)}};return a.rebind(f,d,"on"),f.close=function(){b&&b.close()},f.messageType=function(a){return arguments.length?(e=a,f):e},f.product=function(a){return arguments.length?(c=a,f):c},f}function fc(){function b(b){var e=a.time.second.offset(d.end(),-c*d.granularity());d.start(e),d(b)}var c,d=Rc.data.feed.coinbase();return b.candles=function(a){return arguments.length?(c=a,b):c},a.rebind(b,d,"end","granularity","product"),b}function gc(){var a,b,c,d=Rc.data.random.financial(),e=[86400],f=null,g=function(c){b.setHours(0,0,0,0);var e=864e5;d.startDate(new Date(b-(a-1)*e));var f=d(a);c(null,f)};return g.candles=function(b){return arguments.length?(a=b,g):a},g.end=function(a){return arguments.length?(b=a,g):b},g.granularity=function(a){if(!arguments.length)return c;if(-1===e.indexOf(a))throw new Error("Granularity of "+a+" is not supported. Random Financial Data Generator only supports daily data.");return c=a,g},g.product=function(a){if(!arguments.length)return g;if(null!==a)throw new Error("Random Financial Data Generator does not support products.");return f=a,g},g}function hc(){function b(b){b.each(function(b){var d=a.select(this),e=d.selectAll("div").data(b.selectedIndicators,function(a){return a.valueString}),f=e.enter().append("div").attr("class","edit-indicator");f.append("span").attr("class","icon sc-icon-delete").on("click",c.indicatorChange),f.append("span").attr("class","indicator-label").text(function(a){return a.displayString}),e.exit().remove()})}var c=a.dispatch(Wc.indicatorChange);return a.rebind(b,c,"on"),b}function ic(){var b=a.dispatch(Wc.primaryChartIndicatorChange,Wc.secondaryChartChange),c=hc().on(Wc.indicatorChange,b[Wc.primaryChartIndicatorChange]),d=hc().on(Wc.indicatorChange,b[Wc.secondaryChartChange]),e=function(b){b.each(function(b){var e=a.select(this);e.select("#overlay-primary-container .edit-indicator-container").datum({selectedIndicators:b.primaryIndicators}).call(c),e.selectAll(".overlay-secondary-container").each(function(c,e){var f=a.select(this),g=b.secondaryIndicators[e]?[b.secondaryIndicators[e]]:[];f.select(".edit-indicator-container").datum({selectedIndicators:g}).call(d)})})};return a.rebind(e,b,"on"),e}function jc(){function b(a){var b=a.datum(),d=a.selectAll("g").data([b]);d.enter().append("g").attr("class","reset-button").on("click",function(){c[Wc.resetToLatest]()}).append("path").attr("d","M1.5 1.5h13.438L23 20.218 14.937 38H1.5l9.406-17.782L1.5 1.5z"),d.classed("active",!b.trackingLatest)}var c=a.dispatch(Wc.resetToLatest);return a.rebind(b,c,"on"),b}function kc(){function b(a){var b=a.datum(),h=b.selectedIndex||0,i=b.config,j=d(a,[b.options]);if(i.icon){var k=j.selectAll(".icon").data([0]);k.enter().append("span"),k.attr("class","icon "+b.options[h].icon)}else j.select(".icon").remove(),j.text(function(){return i.title||b.options[h].displayString});e(j,i.careted?[0]:[]);var l=f(a,[b.options]),m=g(l,b.options),n=m.enter().on("click",c.optionChange).append("a").attr("href","#");n.append("span").attr("class","icon"),n.append("span").attr("class","name"),m.selectAll(".icon").attr("class",function(a){return"icon "+a.icon}),m.selectAll(".name").text(function(a){return a.displayString})}var c=a.dispatch("optionChange"),d=Rc.util.dataJoin().selector("button").element("button").attr({"class":"dropdown-toggle",type:"button","data-toggle":"dropdown"}),e=Rc.util.dataJoin().selector(".caret").element("span").attr("class","caret"),f=Rc.util.dataJoin().selector("ul").element("ul").attr("class","dropdown-menu"),g=Rc.util.dataJoin().selector("li").element("li").key(function(a){return a.displayString});return a.rebind(b,c,"on"),b}function lc(){var b=a.dispatch(Wc.primaryChartSeriesChange,Wc.primaryChartIndicatorChange,Wc.secondaryChartChange),c=kc().on("optionChange",b[Wc.primaryChartSeriesChange]),d=kc().on("optionChange",function(a){0===a.valueString.indexOf("secondary")?b[Wc.secondaryChartChange](a):b[Wc.primaryChartIndicatorChange](a)}),e=function(b){b.each(function(b){var e=a.select(this),f=b.seriesSelector.options.map(function(a){return a.isSelected}).indexOf(!0);e.select("#series-dropdown").datum({config:b.seriesSelector.config,options:b.seriesSelector.options,selectedIndex:f}).call(c);var g=b.indicatorSelector.indicatorOptions.concat(b.indicatorSelector.secondaryChartOptions),h=g.map(function(a,b){return a.isSelected?b:null}).filter(function(a){return a});e.select("#indicator-dropdown").datum({config:b.indicatorSelector.config,options:g,selected:h}).call(d)})};return a.rebind(e,b,"on"),e}function mc(){function b(a){var b=a.datum().selectedIndex||0,e=d(a,[a.datum().options]);e.enter().append("ul");var f=e.selectAll("li").data(Rc.util.fn.identity);f.enter().append("li").append("a").attr("href","#").on("click",c.tabClick),f.classed("active",function(a,c){return c===b}).select("a").text(function(a){return a.displayString}),f.exit().remove()}var c=a.dispatch("tabClick"),d=Rc.util.dataJoin().selector("ul").element("ul");return a.rebind(b,c,"on"),b}function nc(){var b=a.dispatch(Wc.dataProductChange,Wc.dataPeriodChange,Wc.clearAllPrimaryChartIndicatorsAndSecondaryCharts),c=kc().on("optionChange",b[Wc.dataProductChange]),d=mc().on("tabClick",b[Wc.dataPeriodChange]),e=kc().on("optionChange",b[Wc.dataPeriodChange]),f=function(f){f.each(function(g){var h=a.select(this),i=g.products;h.select("#product-dropdown").datum({config:g.productConfig,options:i.map(Zb),selectedIndex:i.indexOf(g.selectedProduct)}).call(c);var j=g.selectedProduct.periods;h.select("#period-selector").classed("hidden",j.length<=1).datum({options:j.map($b),selectedIndex:j.indexOf(g.selectedPeriod)}).call(d),h.select("#mobile-period-selector").classed("hidden",j.length<=1).datum({config:g.mobilePeriodConfig,options:j.map($b),selectedIndex:j.indexOf(g.selectedPeriod)}).call(e),h.select("#clear-indicators").on("click",b[Wc.clearAllPrimaryChartIndicatorsAndSecondaryCharts]),f.select("#toggle-button").on("click",function(){b[Wc.toggleSlideout]()})})};return a.rebind(f,b,"on"),f}function oc(){function a(a){var c=++b;return function(d,e){b>c||a(d,e)}}var b=0;return a.invalidateCallback=function(){return b++,a},a}function pc(){function b(a){var b=1e3*f;return new Date(Math.floor(a.getTime()/b)*b)}var c=function(a){return a.date},d=function(a){return Number(a.volume)},e=function(a){return Number(a.price)},f=60,g=function(f,g){var h=b(c(g)),i=e(g),j=d(g),k=a.bisector(function(a){return a.date}).left,l=f.filter(function(a){return a.date.getTime()===h.getTime()})[0];l?(l.high=Math.max(i,l.high),l.low=Math.min(i,l.low),l.close=i,l.volume+=j):f.splice(k(f,h),0,{date:h,open:i,high:i,low:i,close:i,volume:j})};return g.granularity=function(a){return arguments.length?(f=a,g):f},g.price=function(a){return arguments.length?(e=a,g):e},g.volume=function(a){return arguments.length?(d=a,g):d},g.date=function(a){return arguments.length?(c=a,g):c},g}function qc(){function b(){f&&f.close(),k=[],i.invalidateCallback()}function c(a){return a.sort(function(a,b){return a.date-b.date})}function d(a,d){b(),2===arguments.length&&(e=d.source.historic,e.product(d.id),f=d.source.streaming,null!=f&&f.product(d.id));var l=new Date;e.end(l).candles(j).granularity(a),h.granularity(a),e(i(function(a,b){a?g[Wc.historicFeedError](a):(k=c(b),g[Wc.historicDataLoaded](k))})),null!=f&&(f.on("message",function(a){h(k,a),g[Wc.newTrade](k)}).on("error",function(a){
// TODO: The 'close' event is potentially more useful for error info.
g[Wc.streamingFeedError](a)}),f())}var e,f,g=a.dispatch(Wc.historicDataLoaded,Wc.historicFeedError,Wc.newTrade,Wc.streamingFeedError),h=pc().date(function(a){return new Date(a.time)}).volume(function(a){return Number(a.size)}),i=oc(),j=200,k=[];return a.rebind(d,g,"on"),d}function rc(){function b(a){a=a.replace("/[[]/","\\[").replace("/[]]/","\\]");var b=new RegExp("[\\?&]"+a+"=([^&#]*)"),c=b.exec(location.search);return null===c?"":decodeURIComponent(c[1].replace(/\+/g," "))}function c(){Y&&G.suspendLayout(!1),G.primary.datum(N).call(W.primary),G.legend.datum(U).call(W.legend),G.secondaries.datum(O).filter(function(a,b){return b<W.secondaries.length}).each(function(b,c){a.select(this).attr("class","secondary-container "+W.secondaries[c].valueString).call(W.secondaries[c].option)}),G.xAxis.datum(Q).call(W.xAxis),G.navbar.datum(R).call(W.navbar),G.app.select("#navbar-reset").datum(S).call(A),G.app.select(".head-menu").datum(T).call(z),G.app.select("#selectors").datum(P).call(B),G.overlay.datum(V).call(F),Y&&(G.suspendLayout(!0),Y=!1)}function d(){Y=!0,Vc.layout(G,W)}function e(){a.select(window).on("resize",function(){d(),X()})}function f(a){var b=[a[0],a[1]];N.viewDomain=b,O.viewDomain=b,Q.viewDomain=b,R.viewDomain=b;var c=Vc.domain.trackingLatestData(N.viewDomain,N.data);N.trackingLatest=c,O.trackingLatest=c,R.trackingLatest=c,S.trackingLatest=c,X()}function g(a){a.isSelected=!a.isSelected,w(),X()}function h(a){a.isSelected=!a.isSelected,x(),X()}function i(a){U.data=a,X()}function j(){var a=N.data,b=Rc.util.extent().fields("date")(a),c=Vc.domain.moveToLatest(b,a,.2);f(c)}function k(a){D.select("#loading-message").classed("hidden",!a),D.select("#charts").classed("hidden",a)}function l(a){N.data=a,O.data=a,R.data=a}function m(a){T.selectedProduct=a,N.product=a,O.product=a,U.product=a}function n(a){T.selectedPeriod=a,Q.period=a,U.period=a}function o(){return Yc.primary().on(Wc.crosshairChange,i).on(Wc.viewChange,f)}function p(){return Yc.nav().on(Wc.viewChange,f)}function q(){return fd.navigationReset().on(Wc.resetToLatest,j)}function r(){return qc().on(Wc.newTrade,function(a){if(l(a),N.trackingLatest){var b=Vc.domain.moveToLatest(N.viewDomain,N.data);f(b)}}).on(Wc.historicDataLoaded,function(a){k(!1),l(a),U.data=null,j(),d()}).on(Wc.historicFeedError,function(a){console.log("Error getting historic data: "+a)}).on(Wc.streamingFeedError,function(a){console.log("Error loading data from websocket: "+a)})}function s(a){return fd.head().on(Wc.dataProductChange,function(b){k(!0),m(b.option),n(b.option.periods[0]),a(b.option.periods[0].seconds,b.option),X()}).on(Wc.dataPeriodChange,function(b){k(!0),n(b.option),a(b.option.seconds),X()}).on(Wc.clearAllPrimaryChartIndicatorsAndSecondaryCharts,function(){N.indicators.forEach(u),W.secondaries.forEach(u),w(),x(),X()})}function t(a,b){b.forEach(function(a){a.isSelected=!1}),a.isSelected=!0}function u(a){a.isSelected=!1}function v(){return fd.selectors().on(Wc.primaryChartSeriesChange,function(a){N.series=a,t(a,P.seriesSelector.options),X()}).on(Wc.primaryChartIndicatorChange,g).on(Wc.secondaryChartChange,h)}function w(){N.indicators=P.indicatorSelector.indicatorOptions.filter(function(a){return a.isSelected}),V.primaryIndicators=N.indicators}function x(){W.secondaries=P.indicatorSelector.secondaryChartOptions.filter(function(a){return a.isSelected}),
// TODO: This doesn't seem to be a concern of menu.
W.secondaries.forEach(function(a){a.option.on(Wc.viewChange,f)}),V.secondaryIndicators=W.secondaries,
// TODO: Remove .remove! (could a secondary chart group component manage this?).
G.secondaries.selectAll("*").remove(),d()}function y(){return fd.overlay().on(Wc.primaryChartIndicatorChange,g).on(Wc.secondaryChartChange,h)}var z,A,B,C={},D=a.select("#app-container"),E=D.select("#charts-container"),F=D.select("#overlay"),G={app:D,charts:E,primary:E.select("#primary-container"),secondaries:E.selectAll(".secondary-container"),xAxis:E.select("#x-axis-container"),navbar:E.select("#navbar-container"),overlay:F,overlaySecondaries:F.selectAll(".overlay-secondary-container"),legend:D.select("#legend"),suspendLayout:function(a){var b=this;Object.keys(b).forEach(function(c){"function"!=typeof b[c]&&b[c].layoutSuspended(a)})}},H=ed.data.period({display:"Weekly",seconds:604800,d3TimeInterval:{unit:a.time.week,value:1},timeFormat:"%b %d"}),I=ed.data.period({display:"Daily",seconds:86400,d3TimeInterval:{unit:a.time.day,value:1},timeFormat:"%b %d"}),J=(ed.data.period({display:"1 Hr",seconds:3600,d3TimeInterval:{unit:a.time.hour,value:1},timeFormat:"%b %d %Hh"}),ed.data.period({display:"5 Min",seconds:300,d3TimeInterval:{unit:a.time.minute,value:5},timeFormat:"%H:%M"}),ed.data.period({display:"1 Min",seconds:60,d3TimeInterval:{unit:a.time.minute,value:1},timeFormat:"%H:%M"}),ed.data.source(gc())),K=(ed.data.source(fc(),ec()),ed.data.source(dc())),L=ed.data.product({id:null,display:"Data Generator",volumeFormat:".3s",periods:[I],source:J}),M=ed.data.product({id:b("stockcode"),display:b("stockcode"),volumeFormat:".3s",periods:[I,H],source:K}),N=ed.chart.primary(M),O=ed.chart.secondary(M),P=ed.menu.selectors(),Q=ed.chart.xAxis(I),R=ed.chart.nav(),S=ed.chart.navigationReset(),T=ed.menu.head([M,L],M,I),U=ed.chart.legend(M,I),V=ed.menu.overlay(),W={primary:void 0,secondaries:[],xAxis:Yc.xAxis(),navbar:void 0,legend:Yc.legend()},X=Rc.util.render(c),Y=!0;return C.run=function(){W.primary=o(),W.navbar=p();var b=r();z=s(b),A=q(),B=v(),F=y(),d(),e(),b(L.periods[0].seconds,M),a.select("#stock-title").text(M.display)},C}a="default"in a?a["default"]:a;var sc=Object.freeze({randomItem:n,randomIndex:o,cloneAndReplace:p}),tc={boundingBox:t,greedy:s,local:r,annealing:q},uc=Object.freeze({context:u,identity:v,index:w,noop:x}),vc=1e-6,wc=Object.freeze({isOrdinal:z,range:A,setRange:B}),xc={rectangles:D,strategy:tc},yc={dataJoin:y,expandRect:N,extent:M,fn:uc,minimum:e,fractionalBarWidth:L,innerDimensions:K,rebind:b,rebindAll:d,scale:wc,noSnap:F,pointSnap:G,seriesPointSnap:H,seriesPointSnapXOnly:I,seriesPointSnapYOnly:J,render:E,arrayFunctor:C,array:sc},zc={crosshair:V,fibonacciFan:Q,container:P,measure:O},Ac={axis:$,bar:Z,candlestick:Y,ohlc:X,errorBar:W},Bc={waterfall:_},Cc={area:la,bar:ja,stack:ha,line:ia},Dc={area:ka,axis:pa,bar:aa,candlestick:oa,cycle:na,line:ga,multi:S,ohlc:ma,point:U,stacked:Cc,groupedBar:fa,xyBase:T,ohlcBase:ea,errorBar:da,waterfall:ba,algorithm:Bc};ta.tickTransformer=ra;var Ec={discontinuity:{identity:qa,skipWeekends:ua},dateTime:ta},Fc={bollingerBands:Ba,macd:Aa,relativeStrengthIndex:za,stochasticOscillator:ya,forceIndex:xa,envelope:wa,elderRay:va},Gc={bollingerBands:Va,exponentialMovingAverage:Ca,macd:Ra,percentageChange:Ua,relativeStrengthIndex:Oa,stochasticOscillator:Ma,slidingWindow:Ea,undefinedInputAdapter:Ia,forceIndex:Ka,envelope:Ha,elderRay:Da},Hc={bollingerBands:Wa,calculator:Gc,exponentialMovingAverage:Ta,macd:Sa,merge:Fa,movingAverage:Qa,relativeStrengthIndex:Pa,stochasticOscillator:Na,forceIndex:La,envelope:Ja,elderRay:Ga},Ic={algorithm:Hc,renderer:Fc},Jc={modeMedian:$a,largestTriangleThreeBucket:Za,largestTriangleOneBucket:Ya,bucket:Xa},Kc={filter:{skipWeekends:cb},financial:bb,walk:ab},Lc={coinbase:eb,quandl:db},Mc={feed:Lc,random:Kc,spread:_a,sampler:Jc};/**
...
sXML="<svg xmlns='http://www.w3.org/2000/svg'>"+a+"</svg>";for(var c=b.parseFromString(sXML,"text/xml").documentElement,d=c.firstChild;d;)this.appendChild(this.ownerDocument.importNode(d,!0)),d=d.nextSibling}catch(e){throw new Error("Error parsing XML string")}}})}}((1,eval)("this").SVGElement);var Nc={cartesian:ib,sparkline:hb,tooltip:gb,smallMultiples:fb},Oc={band:kb,gridline:jb,line:R},Pc=function(a){var b=a.exports;
...
c.fillNodes(a),c.computeLayout(a)}}),a.exports}({exports:{}});a.selection.prototype.layoutSuspended=sb,a.transition.prototype.layoutSuspended=sb,a.selection.prototype.layout=tb,a.transition.prototype.layout=tb;
// Needs to be defined like this so that the grunt task can update it
var Qc="development",Rc={annotation:Oc,chart:Nc,data:Mc,indicator:Ic,scale:Ec,series:Dc,svg:Ac,tool:zc,util:yc,version:Qc,layout:xc},Sc=0,Tc=!1,Uc={centerOnDate:Ab,filterDataInDateRange:zb,moveToLatest:yb,padYDomain:xb,trackingLatestData:wb},Vc={domain:Uc,layout:vb,uid:ub},Wc={crosshairChange:"crosshairChange",viewChange:"viewChange",newTrade:"newTrade",historicDataLoaded:"historicDataLoaded",historicFeedError:"historicFeedError",streamingFeedError:"streamingFeedError",dataProductChange:"dataProductChange",dataPeriodChange:"dataPeriodChange",resetToLatest:"resetToLatest",clearAllPrimaryChartIndicatorsAndSecondaryCharts:"clearAllPrimaryChartIndicatorsAndSecondaryCharts",primaryChartSeriesChange:"primaryChartSeriesChange",primaryChartYValueAccessorChange:"primaryChartYValueAccessorChange",primaryChartIndicatorChange:"primaryChartIndicatorChange",secondaryChartChange:"secondaryChartChange",indicatorChange:"indicatorChange"},Xc={base:Cb,macd:Fb,rsi:Eb,volume:Db},Yc={legend:Ob,nav:Nb,primary:Mb,xAxis:Gb,secondary:Xc},Zc={period:Rb,product:Qb,source:Pb},$c={legend:Xb,nav:Wb,navigationReset:Vb,primary:Ub,secondary:Tb,xAxis:Sb},_c=Rc.series.line().decorate(function(a){a.enter().classed("movingAverage",!0)}).yValue(function(a){return a.movingAverage});_c.id=Vc.uid();var ad=Rc.indicator.renderer.bollingerBands();ad.id=Vc.uid();var bd=[Hb("Moving Average","movingAverage",_c,"sc-icon-moving-average-indicator"),Hb("Bollinger Bands","bollinger",ad,"sc-icon-bollinger-bands-indicator")],cd=[Hb("Relative Strength Index","secondary-rsi",Xc.rsi(),"sc-icon-rsi-indicator"),Hb("MACD","secondary-macd",Xc.macd(),"sc-icon-macd-indicator"),Hb("Volume","secondary-volume",Xc.volume(),"sc-icon-bar-series")],dd={selectors:cc,head:_b,periodAdaptor:$b,productAdaptor:Zb,overlay:Yb},ed={menu:dd,chart:$c,data:Zc},fd={head:nc,selectors:lc,navigationReset:jc,overlay:ic};rc().run()});