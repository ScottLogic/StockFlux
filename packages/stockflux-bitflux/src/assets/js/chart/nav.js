...
export default function() {
  ...
  var navMulti = fc.series
    ...
    .decorate(function(selection) {
      ...
      selection
        ...
        .attr('y', borderWidth);
      enter.select('.extent').attr('mask', 'url("#brush-mask")');
    ...
    .mapping(function(series) {
      if (series === brush) {
        brush.y(null).extent(viewScale.domain());
        return null;
      } else {
  ...
  function nav(selection) {
    ...
    var yExtent = fc.util
      .extent()
      .fields(['low', 'high'])
      .pad(yExtentPadding)(filteredData);

    navChart
      .xDomain(fc.util.extent().fields(['date'])(sampledData))
      .yDomain(yExtent)
